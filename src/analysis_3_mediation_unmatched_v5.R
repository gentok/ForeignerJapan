#' ---
#' title: "Analysis 3: Mediation Analysis (Unmatched Data)"
...
texreg(list(s0mm01_1C,s0mout01_1C), digits = 4, single.row = T,
       override.se = list(coeftest(s0mm01_1C,vcov.=vcovHC(s0mm01_1C))[,2],
                          coeftest(s0mout01_1C,vcov.=vcovHC(s0mout01_1C))[,2]),
       override.pvalues = list(coeftest(s0mm01_1C,vcov.=vcovHC(s0mm01_1C))[,4],
                               coeftest(s0mout01_1C,vcov.=vcovHC(s0mout01_1C))[,4]),
       ...
       file = paste0(projdir,"/out/s0medout01_1_tabular.tex"))

## Causal Mediation Analysis
set.seed(2345)

## Female
medout01_f25 <- mediate(s0mm01_1C, s0mout01_1C, treat = "edu2", 
                        mediator = "knowledge", 
                        covariates = list(male = 0, agex = -2), robustSE = TRUE)
summary(medout01_f25)
medout01_f35 <- mediate(s0mm01_1C, s0mout01_1C, treat = "edu2", 
                        mediator = "knowledge", 
                        covariates = list(male = 0, agex = -1), robustSE = TRUE)
summary(medout01_f35)
medout01_f45 <- mediate(s0mm01_1C, s0mout01_1C, treat = "edu2", 
                        mediator = "knowledge", 
                        covariates = list(male = 0, agex = 0), robustSE = TRUE)
summary(medout01_f45)
medout01_f55 <- mediate(s0mm01_1C, s0mout01_1C, treat = "edu2", 
                        mediator = "knowledge", 
                        covariates = list(male = 0, agex = 1), robustSE = TRUE)
summary(medout01_f55)
medout01_f65 <- mediate(s0mm01_1C, s0mout01_1C, treat = "edu2", 
                        mediator = "knowledge", 
                        covariates = list(male = 0, agex = 2), robustSE = TRUE)
summary(medout01_f65)
## Male
medout01_m25 <- mediate(s0mm01_1C, s0mout01_1C, treat = "edu2", 
                        mediator = "knowledge", 
                        covariates = list(male = 1, agex = -2), robustSE = TRUE)
summary(medout01_m25)
medout01_m35 <- mediate(s0mm01_1C, s0mout01_1C, treat = "edu2", 
                        mediator = "knowledge", 
                        covariates = list(male = 1, agex = -1), robustSE = TRUE)
summary(medout01_m35)
medout01_m45 <- mediate(s0mm01_1C, s0mout01_1C, treat = "edu2", 
                        mediator = "knowledge", 
                        covariates = list(male = 1, agex = 0), robustSE = TRUE)
summary(medout01_m45)
medout01_m55 <- mediate(s0mm01_1C, s0mout01_1C, treat = "edu2", 
                        mediator = "knowledge", 
                        covariates = list(male = 1, agex = 1), robustSE = TRUE)
summary(medout01_m55)
medout01_m65 <- mediate(s0mm01_1C, s0mout01_1C, treat = "edu2", 
                        mediator = "knowledge", 
                        covariates = list(male = 1, agex = 2), robustSE = TRUE)
...
#+ include = FALSE, eval = FALSE
texreg(list(s0mm02_1C,s0mout02_1C), digits = 4, single.row = T,
       override.se = list(coeftest(s0mm02_1C,vcov.=vcovHC(s0mm02_1C))[,2],
                          coeftest(s0mout02_1C,vcov.=vcovHC(s0mout02_1C))[,2]),
       override.pvalues = list(coeftest(s0mm02_1C,vcov.=vcovHC(s0mm02_1C))[,4],
                               coeftest(s0mout02_1C,vcov.=vcovHC(s0mout02_1C))[,4]),
       ...
       custom.model.names = c("Mediator","Outcome"),
       booktabs = TRUE, dcolumn = TRUE, use.packages = FALSE, table = FALSE, fontsize = "scriptsize",
       file = paste0(projdir,"/out/s0medout02_1_tabular.tex"))
...
## Female
medout02_f25 <- mediate(s0mm02_1C, s0mout02_1C, treat = "edu2", 
                        mediator = "ideology", 
                        covariates = list(male = 0, agex = -2), robustSE = TRUE)
summary(medout02_f25)
medout02_f35 <- mediate(s0mm02_1C, s0mout02_1C, treat = "edu2", 
                        mediator = "ideology", 
                        covariates = list(male = 0, agex = -1), robustSE = TRUE)
summary(medout02_f35)
medout02_f45 <- mediate(s0mm02_1C, s0mout02_1C, treat = "edu2", 
                        mediator = "ideology", 
                        covariates = list(male = 0, agex = 0), robustSE = TRUE)
summary(medout02_f45)
medout02_f55 <- mediate(s0mm02_1C, s0mout02_1C, treat = "edu2", 
                        mediator = "ideology", 
                        covariates = list(male = 0, agex = 1), robustSE = TRUE)
summary(medout02_f55)
medout02_f65 <- mediate(s0mm02_1C, s0mout02_1C, treat = "edu2", 
                        mediator = "ideology", 
                        covariates = list(male = 0, agex = 2), robustSE = TRUE)
summary(medout02_f65)
## Male
medout02_m25 <- mediate(s0mm02_1C, s0mout02_1C, treat = "edu2", 
                        mediator = "ideology", 
                        covariates = list(male = 1, agex = -2), robustSE = TRUE)
summary(medout02_m25)
medout02_m35 <- mediate(s0mm02_1C, s0mout02_1C, treat = "edu2", 
                        mediator = "ideology", 
                        covariates = list(male = 1, agex = -1), robustSE = TRUE)
summary(medout02_m35)
medout02_m45 <- mediate(s0mm02_1C, s0mout02_1C, treat = "edu2", 
                        mediator = "ideology", 
                        covariates = list(male = 1, agex = 0), robustSE = TRUE)
summary(medout02_m45)
medout02_m55 <- mediate(s0mm02_1C, s0mout02_1C, treat = "edu2", 
                        mediator = "ideology", 
                        covariates = list(male = 1, agex = 1), robustSE = TRUE)
summary(medout02_m55)
medout02_m65 <- mediate(s0mm02_1C, s0mout02_1C, treat = "edu2", 
                        mediator = "ideology", 
                        covariates = list(male = 1, agex = 2), robustSE = TRUE)
...
#+ include = FALSE, eval = FALSE
texreg(list(s0mm03_1C,s0mout03_1C), digits = 4, single.row = T,
       override.se = list(coeftest(s0mm03_1C,vcov.=vcovHC(s0mm03_1C))[,2],
                          coeftest(s0mout03_1C,vcov.=vcovHC(s0mout03_1C))[,2]),
       override.pvalues = list(coeftest(s0mm03_1C,vcov.=vcovHC(s0mm03_1C))[,4],
                               coeftest(s0mout03_1C,vcov.=vcovHC(s0mout03_1C))[,4]),
       ...
       custom.model.names = c("Mediator","Outcome"),
       booktabs = TRUE, dcolumn = TRUE, use.packages = FALSE, table = FALSE, fontsize = "scriptsize",
       file = paste0(projdir,"/out/s0medout03_1_tabular.tex"))

## Causal Mediation Analysis
set.seed(2345)

## Female
medout03_f25 <- mediate(s0mm03_1C, s0mout03_1C, treat = "edu2", 
                        mediator = "ldpdpjft", 
                        covariates = list(male = 0, agex = -2), robustSE = TRUE)
summary(medout03_f25)
medout03_f35 <- mediate(s0mm03_1C, s0mout03_1C, treat = "edu2", 
                        mediator = "ldpdpjft", 
                        covariates = list(male = 0, agex = -1), robustSE = TRUE)
summary(medout03_f35)
medout03_f45 <- mediate(s0mm03_1C, s0mout03_1C, treat = "edu2", 
                        mediator = "ldpdpjft", 
                        covariates = list(male = 0, agex = 0), robustSE = TRUE)
summary(medout03_f45)
medout03_f55 <- mediate(s0mm03_1C, s0mout03_1C, treat = "edu2", 
                        mediator = "ldpdpjft", 
                        covariates = list(male = 0, agex = 1), robustSE = TRUE)
summary(medout03_f55)
medout03_f65 <- mediate(s0mm03_1C, s0mout03_1C, treat = "edu2", 
                        mediator = "ldpdpjft", 
                        covariates = list(male = 0, agex = 2), robustSE = TRUE)
summary(medout03_f65)
## Male
medout03_m25 <- mediate(s0mm03_1C, s0mout03_1C, treat = "edu2", 
                        mediator = "ldpdpjft", 
                        covariates = list(male = 1, agex = -2), robustSE = TRUE)
summary(medout03_m25)
medout03_m35 <- mediate(s0mm03_1C, s0mout03_1C, treat = "edu2", 
                        mediator = "ldpdpjft", 
                        covariates = list(male = 1, agex = -1), robustSE = TRUE)
summary(medout03_m35)
medout03_m45 <- mediate(s0mm03_1C, s0mout03_1C, treat = "edu2", 
                        mediator = "ldpdpjft", 
                        covariates = list(male = 1, agex = 0), robustSE = TRUE)
summary(medout03_m45)
medout03_m55 <- mediate(s0mm03_1C, s0mout03_1C, treat = "edu2", 
                        mediator = "ldpdpjft", 
                        covariates = list(male = 1, agex = 1), robustSE = TRUE)
summary(medout03_m55)
medout03_m65 <- mediate(s0mm03_1C, s0mout03_1C, treat = "edu2", 
                        mediator = "ldpdpjft", 
                        covariates = list(male = 1, agex = 2), robustSE = TRUE)
...
#+ include = FALSE, eval = FALSE
texreg(list(s0mm04_1C,s0mout04_1C), digits = 4, single.row = T,
       override.se = list(coeftest(s0mm04_1C,vcov.=vcovHC(s0mm04_1C))[,2],
                          coeftest(s0mout04_1C,vcov.=vcovHC(s0mout04_1C))[,2]),
       override.pvalues = list(coeftest(s0mm04_1C,vcov.=vcovHC(s0mm04_1C))[,4],
                               coeftest(s0mout04_1C,vcov.=vcovHC(s0mout04_1C))[,4]),
       ...
       custom.model.names = c("Mediator","Outcome"),
       booktabs = TRUE, dcolumn = TRUE, use.packages = FALSE, table = FALSE, fontsize = "scriptsize",
       file = paste0(projdir,"/out/s0medout04_1_tabular.tex"))
...
## Female
medout04_f25 <- mediate(s0mm04_1C, s0mout04_1C, treat = "edu2", 
                        mediator = "familiarityFT_KOR", 
                        covariates = list(male = 0, agex = -2), robustSE = TRUE)
summary(medout04_f25)
medout04_f35 <- mediate(s0mm04_1C, s0mout04_1C, treat = "edu2", 
                        mediator = "familiarityFT_KOR", 
                        covariates = list(male = 0, agex = -1), robustSE = TRUE)
summary(medout04_f35)
medout04_f45 <- mediate(s0mm04_1C, s0mout04_1C, treat = "edu2", 
                        mediator = "familiarityFT_KOR", 
                        covariates = list(male = 0, agex = 0), robustSE = TRUE)
summary(medout04_f45)
medout04_f55 <- mediate(s0mm04_1C, s0mout04_1C, treat = "edu2", 
                        mediator = "familiarityFT_KOR", 
                        covariates = list(male = 0, agex = 1), robustSE = TRUE)
summary(medout04_f55)
medout04_f65 <- mediate(s0mm04_1C, s0mout04_1C, treat = "edu2", 
                        mediator = "familiarityFT_KOR", 
                        covariates = list(male = 0, agex = 2), robustSE = TRUE)
summary(medout04_f65)
## Male
medout04_m25 <- mediate(s0mm04_1C, s0mout04_1C, treat = "edu2", 
                        mediator = "familiarityFT_KOR", 
                        covariates = list(male = 1, agex = -2), robustSE = TRUE)
summary(medout04_m25)
medout04_m35 <- mediate(s0mm04_1C, s0mout04_1C, treat = "edu2", 
                        mediator = "familiarityFT_KOR", 
                        covariates = list(male = 1, agex = -1), robustSE = TRUE)
summary(medout04_m35)
medout04_m45 <- mediate(s0mm04_1C, s0mout04_1C, treat = "edu2", 
                        mediator = "familiarityFT_KOR", 
                        covariates = list(male = 1, agex = 0), robustSE = TRUE)
summary(medout04_m45)
medout04_m55 <- mediate(s0mm04_1C, s0mout04_1C, treat = "edu2", 
                        mediator = "familiarityFT_KOR", 
                        covariates = list(male = 1, agex = 1), robustSE = TRUE)
summary(medout04_m55)
medout04_m65 <- mediate(s0mm04_1C, s0mout04_1C, treat = "edu2", 
                        mediator = "familiarityFT_KOR", 
                        covariates = list(male = 1, agex = 2), robustSE = TRUE)
...
#+ include = FALSE, eval = FALSE
texreg(list(s0mm05_1C,s0mout05_1C), digits = 4, single.row = T,
       override.se = list(coeftest(s0mm05_1C,vcov.=vcovHC(s0mm05_1C))[,2],
                          coeftest(s0mout05_1C,vcov.=vcovHC(s0mout05_1C))[,2]),
       override.pvalues = list(coeftest(s0mm05_1C,vcov.=vcovHC(s0mm05_1C))[,4],
                               coeftest(s0mout05_1C,vcov.=vcovHC(s0mout05_1C))[,4]),
       ...
       custom.model.names = c("Mediator","Outcome"),
       booktabs = TRUE, dcolumn = TRUE, use.packages = FALSE, table = FALSE, fontsize = "scriptsize",
       file = paste0(projdir,"/out/s0medout05_1_tabular.tex"))
...
## Female
medout05_f25 <- mediate(s0mm05_1C, s0mout05_1C, treat = "edu2", 
                        mediator = "familiarityFT_CHN", 
                        covariates = list(male = 0, agex = -2), robustSE = TRUE)
summary(medout05_f25)
medout05_f35 <- mediate(s0mm05_1C, s0mout05_1C, treat = "edu2", 
                        mediator = "familiarityFT_CHN", 
                        covariates = list(male = 0, agex = -1), robustSE = TRUE)
summary(medout05_f35)
medout05_f45 <- mediate(s0mm05_1C, s0mout05_1C, treat = "edu2", 
                        mediator = "familiarityFT_CHN", 
                        covariates = list(male = 0, agex = 0), robustSE = TRUE)
summary(medout05_f45)
medout05_f55 <- mediate(s0mm05_1C, s0mout05_1C, treat = "edu2", 
                        mediator = "familiarityFT_CHN", 
                        covariates = list(male = 0, agex = 1), robustSE = TRUE)
summary(medout05_f55)
medout05_f65 <- mediate(s0mm05_1C, s0mout05_1C, treat = "edu2", 
                        mediator = "familiarityFT_CHN", 
                        covariates = list(male = 0, agex = 2), robustSE = TRUE)
summary(medout05_f65)
## Male
medout05_m25 <- mediate(s0mm05_1C, s0mout05_1C, treat = "edu2", 
                        mediator = "familiarityFT_CHN", 
                        covariates = list(male = 1, agex = -2), robustSE = TRUE)
summary(medout05_m25)
medout05_m35 <- mediate(s0mm05_1C, s0mout05_1C, treat = "edu2", 
                        mediator = "familiarityFT_CHN", 
                        covariates = list(male = 1, agex = -1), robustSE = TRUE)
summary(medout05_m35)
medout05_m45 <- mediate(s0mm05_1C, s0mout05_1C, treat = "edu2", 
                        mediator = "familiarityFT_CHN", 
                        covariates = list(male = 1, agex = 0), robustSE = TRUE)
summary(medout05_m45)
medout05_m55 <- mediate(s0mm05_1C, s0mout05_1C, treat = "edu2", 
                        mediator = "familiarityFT_CHN", 
                        covariates = list(male = 1, agex = 1), robustSE = TRUE)
summary(medout05_m55)
medout05_m65 <- mediate(s0mm05_1C, s0mout05_1C, treat = "edu2", 
                        mediator = "familiarityFT_CHN", 
                        covariates = list(male = 1, agex = 2), robustSE = TRUE)
...
#+ include = FALSE, eval = FALSE
texreg(list(s0mm06_1C,s0mout06_1C), digits = 4, single.row = T,
       override.se = list(coeftest(s0mm06_1C,vcov.=vcovHC(s0mm06_1C))[,2],
                          coeftest(s0mout06_1C,vcov.=vcovHC(s0mout06_1C))[,2]),
       override.pvalues = list(coeftest(s0mm06_1C,vcov.=vcovHC(s0mm06_1C))[,4],
                               coeftest(s0mout06_1C,vcov.=vcovHC(s0mout06_1C))[,4]),
       ...
       custom.model.names = c("Mediator","Outcome"),
       booktabs = TRUE, dcolumn = TRUE, use.packages = FALSE, table = FALSE, fontsize = "scriptsize",
       file = paste0(projdir,"/out/s0medout06_1_tabular.tex"))
...
## Female
medout06_f25 <- mediate(s0mm06_1C, s0mout06_1C, treat = "edu2", 
                        mediator = "familiarityFT_USA", 
                        covariates = list(male = 0, agex = -2), robustSE = TRUE)
summary(medout06_f25)
medout06_f35 <- mediate(s0mm06_1C, s0mout06_1C, treat = "edu2", 
                        mediator = "familiarityFT_USA", 
                        covariates = list(male = 0, agex = -1), robustSE = TRUE)
summary(medout06_f35)
medout06_f45 <- mediate(s0mm06_1C, s0mout06_1C, treat = "edu2", 
                        mediator = "familiarityFT_USA", 
                        covariates = list(male = 0, agex = 0), robustSE = TRUE)
summary(medout06_f45)
medout06_f55 <- mediate(s0mm06_1C, s0mout06_1C, treat = "edu2", 
                        mediator = "familiarityFT_USA", 
                        covariates = list(male = 0, agex = 1), robustSE = TRUE)
summary(medout06_f55)
medout06_f65 <- mediate(s0mm06_1C, s0mout06_1C, treat = "edu2", 
                        mediator = "familiarityFT_USA", 
                        covariates = list(male = 0, agex = 2), robustSE = TRUE)
summary(medout06_f65)
## Male
medout06_m25 <- mediate(s0mm06_1C, s0mout06_1C, treat = "edu2", 
                        mediator = "familiarityFT_USA", 
                        covariates = list(male = 1, agex = -2), robustSE = TRUE)
summary(medout06_m25)
medout06_m35 <- mediate(s0mm06_1C, s0mout06_1C, treat = "edu2", 
                        mediator = "familiarityFT_USA", 
                        covariates = list(male = 1, agex = -1), robustSE = TRUE)
summary(medout06_m35)
medout06_m45 <- mediate(s0mm06_1C, s0mout06_1C, treat = "edu2", 
                        mediator = "familiarityFT_USA", 
                        covariates = list(male = 1, agex = 0), robustSE = TRUE)
summary(medout06_m45)
medout06_m55 <- mediate(s0mm06_1C, s0mout06_1C, treat = "edu2", 
                        mediator = "familiarityFT_USA", 
                        covariates = list(male = 1, agex = 1), robustSE = TRUE)
summary(medout06_m55)
medout06_m65 <- mediate(s0mm06_1C, s0mout06_1C, treat = "edu2", 
                        mediator = "familiarityFT_USA", 
                        covariates = list(male = 1, agex = 2), robustSE = TRUE)
...
#+ include = FALSE, eval = FALSE
texreg(list(s0mm07_1C,s0mout07_1C), digits = 4, single.row = T,
       override.se = list(coeftest(s0mm07_1C,vcov.=vcovHC(s0mm07_1C))[,2],
                          coeftest(s0mout07_1C,vcov.=vcovHC(s0mout07_1C))[,2]),
       override.pvalues = list(coeftest(s0mm07_1C,vcov.=vcovHC(s0mm07_1C))[,4],
                               coeftest(s0mout07_1C,vcov.=vcovHC(s0mout07_1C))[,4]),
       ...
       custom.model.names = c("Mediator","Outcome"),
       booktabs = TRUE, dcolumn = TRUE, use.packages = FALSE, table = FALSE, fontsize = "scriptsize",
       file = paste0(projdir,"/out/s0medout07_1_tabular.tex"))
...
## Female
medout07_f25 <- mediate(s0mm07_1C, s0mout07_1C, treat = "edu2", 
                        mediator = "income", 
                        covariates = list(male = 0, agex = -2), robustSE = TRUE)
summary(medout07_f25)
medout07_f35 <- mediate(s0mm07_1C, s0mout07_1C, treat = "edu2", 
                        mediator = "income", 
                        covariates = list(male = 0, agex = -1), robustSE = TRUE)
summary(medout07_f35)
medout07_f45 <- mediate(s0mm07_1C, s0mout07_1C, treat = "edu2", 
                        mediator = "income", 
                        covariates = list(male = 0, agex = 0), robustSE = TRUE)
summary(medout07_f45)
medout07_f55 <- mediate(s0mm07_1C, s0mout07_1C, treat = "edu2", 
                        mediator = "income", 
                        covariates = list(male = 0, agex = 1), robustSE = TRUE)
summary(medout07_f55)
medout07_f65 <- mediate(s0mm07_1C, s0mout07_1C, treat = "edu2", 
                        mediator = "income", 
                        covariates = list(male = 0, agex = 2), robustSE = TRUE)
summary(medout07_f65)
## Male
medout07_m25 <- mediate(s0mm07_1C, s0mout07_1C, treat = "edu2", 
                        mediator = "income", 
                        covariates = list(male = 1, agex = -2), robustSE = TRUE)
summary(medout07_m25)
medout07_m35 <- mediate(s0mm07_1C, s0mout07_1C, treat = "edu2", 
                        mediator = "income", 
                        covariates = list(male = 1, agex = -1), robustSE = TRUE)
summary(medout07_m35)
medout07_m45 <- mediate(s0mm07_1C, s0mout07_1C, treat = "edu2", 
                        mediator = "income", 
                        covariates = list(male = 1, agex = 0), robustSE = TRUE)
summary(medout07_m45)
medout07_m55 <- mediate(s0mm07_1C, s0mout07_1C, treat = "edu2", 
                        mediator = "income", 
                        covariates = list(male = 1, agex = 1), robustSE = TRUE)
summary(medout07_m55)
medout07_m65 <- mediate(s0mm07_1C, s0mout07_1C, treat = "edu2", 
                        mediator = "income", 
                        covariates = list(male = 1, agex = 2), robustSE = TRUE)
...
#+ echo=FALSE
coefdt <- readRDS(paste0(projdir,"/out/medoutcoefdt_unmatched_v5.rds"))
...
# Exporting HTML File
# In R Studio
# rmarkdown::render('./src/analysis_3_mediation_unmatched_v5.R', rmarkdown::pdf_document(latex_engine="xelatex", extra_dependencies = list(bookmark=NULL, xltxtra=NULL, zxjatype=NULL, zxjafont=c("ipa"))), encoding = 'UTF-8')
# rmarkdown::render('./src/analysis_3_mediation_unmatched_v5.R', 'github_document', clean=FALSE)
