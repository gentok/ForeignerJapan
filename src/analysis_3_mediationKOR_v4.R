#' ---
#' title: "Analysis 3: Mediation Analysis with Feeling Towards Korea"
...
# Exporting HTML File
# In R Studio
# rmarkdown::render('./src/analysis_3_mediationKOR_v4.R', 'github_document', clean=FALSE)
...
# Rscript -e "rmarkdown::render('analysis_3_mediationKOR_v4.R', 'github_document', clean=FALSE)"
