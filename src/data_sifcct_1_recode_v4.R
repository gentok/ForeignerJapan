...
# Exporting HTML File
# In R Studio
# rmarkdown::render('./src/data_sifcct_1_recode_v4.R', 'pdf_document', encoding = 'UTF-8')
# rmarkdown::render('./src/data_sifcct_1_recode_v4.R', 'github_document', clean=FALSE)
...
# Rscript -e "rmarkdown::render('data_sifcct_1_recode_v4.R', 'pdf_document', encoding = 'UTF-8')"
# Rscript -e "rmarkdown::render('data_sifcct_1_recode_v4.R', 'github_document', clean=FALSE)"
