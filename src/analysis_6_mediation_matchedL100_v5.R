#' ---
#' title: "Analysis 6: Mediation Analysis (Matched with Lambda = 100km)"
...
#' # Models
#' 
#' ## SIFCCT (Matched with Lambda = 100km)
#'
...
## Outcome Model 
s3mout01_1C <- lm(foreignsuff  ~ edu2*male*agex + knowledge*male*agex + lvpr +  
...
## Mediator Model
s3mm01_1C <- lm(knowledge  ~ edu2*male*agex + lvpr +  
                  zip_did + sqrt(c10_sreg_fper) + I(c10_sreg_edu_ugsP/10) + 
                  didper + sqrt(c10_mun_fper) + I(c10_mun_edu_ugsP/10) + 
                  as.factor(wave), data=sifcct)

## Table
screenreg(list(s3mm01_1C,s3mout01_1C), digits = 4, single.row = T,
          override.se = list(coeftest(s3mm01_1C,vcov.=vcovHC(s3mm01_1C))[,2],
                             coeftest(s3mout01_1C,vcov.=vcovHC(s3mout01_1C))[,2]),
          override.pvalues = list(coeftest(s3mm01_1C,vcov.=vcovHC(s3mm01_1C))[,4],
                                  coeftest(s3mout01_1C,vcov.=vcovHC(s3mout01_1C))[,4]),
          omit.coef = "(wave)", stars = c(0.1,0.05,0.01,0.001), symbol = "+",
          custom.coef.map = vnmap, 
          custom.model.names = c("Mediator","Outcome"))

#+ include = FALSE, eval = FALSE
texreg(list(s3mm01_1C,s3mout01_1C), digits = 4, single.row = T,
       override.se = list(coeftest(s3mm01_1C,vcov.=vcovHC(s3mm01_1C))[,2],
                          coeftest(s3mout01_1C,vcov.=vcovHC(s3mout01_1C))[,2]),
       override.pvalues = list(coeftest(s3mm01_1C,vcov.=vcovHC(s3mm01_1C))[,4],
                               coeftest(s3mout01_1C,vcov.=vcovHC(s3mout01_1C))[,4]),
       ...
       file = paste0(projdir,"/out/s3medout01_1_tabular.tex"))

## Causal Mediation Analysis
set.seed(2345)

## Female
medout01_f25 <- mediate(s3mm01_1C, s3mout01_1C, treat = "edu2", 
                        mediator = "knowledge", 
                        covariates = list(male = 0, agex = -2), robustSE = TRUE)
summary(medout01_f25)
medout01_f35 <- mediate(s3mm01_1C, s3mout01_1C, treat = "edu2", 
                        mediator = "knowledge", 
                        covariates = list(male = 0, agex = -1), robustSE = TRUE)
summary(medout01_f35)
medout01_f45 <- mediate(s3mm01_1C, s3mout01_1C, treat = "edu2", 
                        mediator = "knowledge", 
                        covariates = list(male = 0, agex = 0), robustSE = TRUE)
summary(medout01_f45)
medout01_f55 <- mediate(s3mm01_1C, s3mout01_1C, treat = "edu2", 
                        mediator = "knowledge", 
                        covariates = list(male = 0, agex = 1), robustSE = TRUE)
summary(medout01_f55)
medout01_f65 <- mediate(s3mm01_1C, s3mout01_1C, treat = "edu2", 
                        mediator = "knowledge", 
                        covariates = list(male = 0, agex = 2), robustSE = TRUE)
summary(medout01_f65)
## Male
medout01_m25 <- mediate(s3mm01_1C, s3mout01_1C, treat = "edu2", 
                        mediator = "knowledge", 
                        covariates = list(male = 1, agex = -2), robustSE = TRUE)
summary(medout01_m25)
medout01_m35 <- mediate(s3mm01_1C, s3mout01_1C, treat = "edu2", 
                        mediator = "knowledge", 
                        covariates = list(male = 1, agex = -1), robustSE = TRUE)
summary(medout01_m35)
medout01_m45 <- mediate(s3mm01_1C, s3mout01_1C, treat = "edu2", 
                        mediator = "knowledge", 
                        covariates = list(male = 1, agex = 0), robustSE = TRUE)
summary(medout01_m45)
medout01_m55 <- mediate(s3mm01_1C, s3mout01_1C, treat = "edu2", 
                        mediator = "knowledge", 
                        covariates = list(male = 1, agex = 1), robustSE = TRUE)
summary(medout01_m55)
medout01_m65 <- mediate(s3mm01_1C, s3mout01_1C, treat = "edu2", 
                        mediator = "knowledge", 
                        covariates = list(male = 1, agex = 2), robustSE = TRUE)
...
## Outcome Model 
s3mout02_1C <- lm(foreignsuff  ~ edu2*male*agex + ideology*male*agex + lvpr +  
                    zip_did + sqrt(c10_sreg_fper) + I(c10_sreg_edu_ugsP/10) + 
                    didper + sqrt(c10_mun_fper) + I(c10_mun_edu_ugsP/10) + 
                    as.factor(wave), data=sifcct)

## Mediator Model
s3mm02_1C <- lm(ideology  ~ edu2*male*agex + lvpr +  
                  zip_did + sqrt(c10_sreg_fper) + I(c10_sreg_edu_ugsP/10) + 
                  didper + sqrt(c10_mun_fper) + I(c10_mun_edu_ugsP/10) + 
                  as.factor(wave), data=sifcct)

## Table
screenreg(list(s3mm02_1C,s3mout02_1C), digits = 4, single.row = T,
          override.se = list(coeftest(s3mm02_1C,vcov.=vcovHC(s3mm02_1C))[,2],
                             coeftest(s3mout02_1C,vcov.=vcovHC(s3mout02_1C))[,2]),
          override.pvalues = list(coeftest(s3mm02_1C,vcov.=vcovHC(s3mm02_1C))[,4],
                                  coeftest(s3mout02_1C,vcov.=vcovHC(s3mout02_1C))[,4]),
          omit.coef = "(wave)", stars = c(0.1,0.05,0.01,0.001), symbol = "+",
          custom.coef.map = vnmap, 
          custom.model.names = c("Mediator","Outcome"))

#+ include = FALSE, eval = FALSE
texreg(list(s3mm02_1C,s3mout02_1C), digits = 4, single.row = T,
       override.se = list(coeftest(s3mm02_1C,vcov.=vcovHC(s3mm02_1C))[,2],
                          coeftest(s3mout02_1C,vcov.=vcovHC(s3mout02_1C))[,2]),
       override.pvalues = list(coeftest(s3mm02_1C,vcov.=vcovHC(s3mm02_1C))[,4],
                               coeftest(s3mout02_1C,vcov.=vcovHC(s3mout02_1C))[,4]),
       ...
       custom.model.names = c("Mediator","Outcome"),
       booktabs = TRUE, dcolumn = TRUE, use.packages = FALSE, table = FALSE, fontsize = "scriptsize",
       file = paste0(projdir,"/out/s3medout02_1_tabular.tex"))
...
## Female
medout02_f25 <- mediate(s3mm02_1C, s3mout02_1C, treat = "edu2", 
                        mediator = "ideology", 
                        covariates = list(male = 0, agex = -2), robustSE = TRUE)
summary(medout02_f25)
medout02_f35 <- mediate(s3mm02_1C, s3mout02_1C, treat = "edu2", 
                        mediator = "ideology", 
                        covariates = list(male = 0, agex = -1), robustSE = TRUE)
summary(medout02_f35)
medout02_f45 <- mediate(s3mm02_1C, s3mout02_1C, treat = "edu2", 
                        mediator = "ideology", 
                        covariates = list(male = 0, agex = 0), robustSE = TRUE)
summary(medout02_f45)
medout02_f55 <- mediate(s3mm02_1C, s3mout02_1C, treat = "edu2", 
                        mediator = "ideology", 
                        covariates = list(male = 0, agex = 1), robustSE = TRUE)
summary(medout02_f55)
medout02_f65 <- mediate(s3mm02_1C, s3mout02_1C, treat = "edu2", 
                        mediator = "ideology", 
                        covariates = list(male = 0, agex = 2), robustSE = TRUE)
summary(medout02_f65)
## Male
medout02_m25 <- mediate(s3mm02_1C, s3mout02_1C, treat = "edu2", 
                        mediator = "ideology", 
                        covariates = list(male = 1, agex = -2), robustSE = TRUE)
summary(medout02_m25)
medout02_m35 <- mediate(s3mm02_1C, s3mout02_1C, treat = "edu2", 
                        mediator = "ideology", 
                        covariates = list(male = 1, agex = -1), robustSE = TRUE)
summary(medout02_m35)
medout02_m45 <- mediate(s3mm02_1C, s3mout02_1C, treat = "edu2", 
                        mediator = "ideology", 
                        covariates = list(male = 1, agex = 0), robustSE = TRUE)
summary(medout02_m45)
medout02_m55 <- mediate(s3mm02_1C, s3mout02_1C, treat = "edu2", 
                        mediator = "ideology", 
                        covariates = list(male = 1, agex = 1), robustSE = TRUE)
summary(medout02_m55)
medout02_m65 <- mediate(s3mm02_1C, s3mout02_1C, treat = "edu2", 
                        mediator = "ideology", 
                        covariates = list(male = 1, agex = 2), robustSE = TRUE)
...
## Outcome Model 
s3mout03_1C <- lm(foreignsuff  ~ edu2*male*agex + ldpdpjft*male*agex + lvpr +  
                    zip_did + sqrt(c10_sreg_fper) + I(c10_sreg_edu_ugsP/10) + 
                    didper + sqrt(c10_mun_fper) + I(c10_mun_edu_ugsP/10) + 
                    as.factor(wave), data=sifcct)

## Mediator Model
s3mm03_1C <- lm(ldpdpjft ~ edu2*male*agex + lvpr +  
                  zip_did + sqrt(c10_sreg_fper) + I(c10_sreg_edu_ugsP/10) + 
                  didper + sqrt(c10_mun_fper) + I(c10_mun_edu_ugsP/10) + 
                  as.factor(wave), data=sifcct)

## Table
screenreg(list(s3mm03_1C,s3mout03_1C), digits = 4, single.row = T,
          override.se = list(coeftest(s3mm03_1C,vcov.=vcovHC(s3mm03_1C))[,2],
                             coeftest(s3mout03_1C,vcov.=vcovHC(s3mout03_1C))[,2]),
          override.pvalues = list(coeftest(s3mm03_1C,vcov.=vcovHC(s3mm03_1C))[,4],
                                  coeftest(s3mout03_1C,vcov.=vcovHC(s3mout03_1C))[,4]),
          omit.coef = "(wave)", stars = c(0.1,0.05,0.01,0.001), symbol = "+",
          custom.coef.map = vnmap, 
          custom.model.names = c("Mediator","Outcome"))

#+ include = FALSE, eval = FALSE
texreg(list(s3mm03_1C,s3mout03_1C), digits = 4, single.row = T,
       override.se = list(coeftest(s3mm03_1C,vcov.=vcovHC(s3mm03_1C))[,2],
                          coeftest(s3mout03_1C,vcov.=vcovHC(s3mout03_1C))[,2]),
       override.pvalues = list(coeftest(s3mm03_1C,vcov.=vcovHC(s3mm03_1C))[,4],
                               coeftest(s3mout03_1C,vcov.=vcovHC(s3mout03_1C))[,4]),
       ...
       custom.model.names = c("Mediator","Outcome"),
       booktabs = TRUE, dcolumn = TRUE, use.packages = FALSE, table = FALSE, fontsize = "scriptsize",
       file = paste0(projdir,"/out/s3medout03_1_tabular.tex"))

## Causal Mediation Analysis
set.seed(2345)

## Female
medout03_f25 <- mediate(s3mm03_1C, s3mout03_1C, treat = "edu2", 
                        mediator = "ldpdpjft", 
                        covariates = list(male = 0, agex = -2), robustSE = TRUE)
summary(medout03_f25)
medout03_f35 <- mediate(s3mm03_1C, s3mout03_1C, treat = "edu2", 
                        mediator = "ldpdpjft", 
                        covariates = list(male = 0, agex = -1), robustSE = TRUE)
summary(medout03_f35)
medout03_f45 <- mediate(s3mm03_1C, s3mout03_1C, treat = "edu2", 
                        mediator = "ldpdpjft", 
                        covariates = list(male = 0, agex = 0), robustSE = TRUE)
summary(medout03_f45)
medout03_f55 <- mediate(s3mm03_1C, s3mout03_1C, treat = "edu2", 
                        mediator = "ldpdpjft", 
                        covariates = list(male = 0, agex = 1), robustSE = TRUE)
summary(medout03_f55)
medout03_f65 <- mediate(s3mm03_1C, s3mout03_1C, treat = "edu2", 
                        mediator = "ldpdpjft", 
                        covariates = list(male = 0, agex = 2), robustSE = TRUE)
summary(medout03_f65)
## Male
medout03_m25 <- mediate(s3mm03_1C, s3mout03_1C, treat = "edu2", 
                        mediator = "ldpdpjft", 
                        covariates = list(male = 1, agex = -2), robustSE = TRUE)
summary(medout03_m25)
medout03_m35 <- mediate(s3mm03_1C, s3mout03_1C, treat = "edu2", 
                        mediator = "ldpdpjft", 
                        covariates = list(male = 1, agex = -1), robustSE = TRUE)
summary(medout03_m35)
medout03_m45 <- mediate(s3mm03_1C, s3mout03_1C, treat = "edu2", 
                        mediator = "ldpdpjft", 
                        covariates = list(male = 1, agex = 0), robustSE = TRUE)
summary(medout03_m45)
medout03_m55 <- mediate(s3mm03_1C, s3mout03_1C, treat = "edu2", 
                        mediator = "ldpdpjft", 
                        covariates = list(male = 1, agex = 1), robustSE = TRUE)
summary(medout03_m55)
medout03_m65 <- mediate(s3mm03_1C, s3mout03_1C, treat = "edu2", 
                        mediator = "ldpdpjft", 
                        covariates = list(male = 1, agex = 2), robustSE = TRUE)
...
## Outcome Model 
s3mout04_1C <- lm(foreignsuff  ~ edu2*male*agex + familiarityFT_KOR*male*agex + lvpr +  
                    zip_did + sqrt(c10_sreg_fper) + I(c10_sreg_edu_ugsP/10) + 
                    didper + sqrt(c10_mun_fper) + I(c10_mun_edu_ugsP/10) + 
                    as.factor(wave), data=sifcct)

## Mediator Model
s3mm04_1C <- lm(familiarityFT_KOR  ~ edu2*male*agex + lvpr +  
                  zip_did + sqrt(c10_sreg_fper) + I(c10_sreg_edu_ugsP/10) + 
                  didper + sqrt(c10_mun_fper) + I(c10_mun_edu_ugsP/10) + 
                  as.factor(wave), data=sifcct)

## Table
screenreg(list(s3mm04_1C,s3mout04_1C), digits = 4, single.row = T,
          override.se = list(coeftest(s3mm04_1C,vcov.=vcovHC(s3mm04_1C))[,2],
                             coeftest(s3mout04_1C,vcov.=vcovHC(s3mout04_1C))[,2]),
          override.pvalues = list(coeftest(s3mm04_1C,vcov.=vcovHC(s3mm04_1C))[,4],
                                  coeftest(s3mout04_1C,vcov.=vcovHC(s3mout04_1C))[,4]),
          omit.coef = "(wave)", stars = c(0.1,0.05,0.01,0.001), symbol = "+",
          custom.coef.map = vnmap, 
          custom.model.names = c("Mediator","Outcome"))

#+ include = FALSE, eval = FALSE
texreg(list(s3mm04_1C,s3mout04_1C), digits = 4, single.row = T,
       override.se = list(coeftest(s3mm04_1C,vcov.=vcovHC(s3mm04_1C))[,2],
                          coeftest(s3mout04_1C,vcov.=vcovHC(s3mout04_1C))[,2]),
       override.pvalues = list(coeftest(s3mm04_1C,vcov.=vcovHC(s3mm04_1C))[,4],
                               coeftest(s3mout04_1C,vcov.=vcovHC(s3mout04_1C))[,4]),
       ...
       custom.model.names = c("Mediator","Outcome"),
       booktabs = TRUE, dcolumn = TRUE, use.packages = FALSE, table = FALSE, fontsize = "scriptsize",
       file = paste0(projdir,"/out/s3medout04_1_tabular.tex"))
...
## Female
medout04_f25 <- mediate(s3mm04_1C, s3mout04_1C, treat = "edu2", 
                        mediator = "familiarityFT_KOR", 
                        covariates = list(male = 0, agex = -2), robustSE = TRUE)
summary(medout04_f25)
medout04_f35 <- mediate(s3mm04_1C, s3mout04_1C, treat = "edu2", 
                        mediator = "familiarityFT_KOR", 
                        covariates = list(male = 0, agex = -1), robustSE = TRUE)
summary(medout04_f35)
medout04_f45 <- mediate(s3mm04_1C, s3mout04_1C, treat = "edu2", 
                        mediator = "familiarityFT_KOR", 
                        covariates = list(male = 0, agex = 0), robustSE = TRUE)
summary(medout04_f45)
medout04_f55 <- mediate(s3mm04_1C, s3mout04_1C, treat = "edu2", 
                        mediator = "familiarityFT_KOR", 
                        covariates = list(male = 0, agex = 1), robustSE = TRUE)
summary(medout04_f55)
medout04_f65 <- mediate(s3mm04_1C, s3mout04_1C, treat = "edu2", 
                        mediator = "familiarityFT_KOR", 
                        covariates = list(male = 0, agex = 2), robustSE = TRUE)
summary(medout04_f65)
## Male
medout04_m25 <- mediate(s3mm04_1C, s3mout04_1C, treat = "edu2", 
                        mediator = "familiarityFT_KOR", 
                        covariates = list(male = 1, agex = -2), robustSE = TRUE)
summary(medout04_m25)
medout04_m35 <- mediate(s3mm04_1C, s3mout04_1C, treat = "edu2", 
                        mediator = "familiarityFT_KOR", 
                        covariates = list(male = 1, agex = -1), robustSE = TRUE)
summary(medout04_m35)
medout04_m45 <- mediate(s3mm04_1C, s3mout04_1C, treat = "edu2", 
                        mediator = "familiarityFT_KOR", 
                        covariates = list(male = 1, agex = 0), robustSE = TRUE)
summary(medout04_m45)
medout04_m55 <- mediate(s3mm04_1C, s3mout04_1C, treat = "edu2", 
                        mediator = "familiarityFT_KOR", 
                        covariates = list(male = 1, agex = 1), robustSE = TRUE)
summary(medout04_m55)
medout04_m65 <- mediate(s3mm04_1C, s3mout04_1C, treat = "edu2", 
                        mediator = "familiarityFT_KOR", 
                        covariates = list(male = 1, agex = 2), robustSE = TRUE)
...
## Outcome Model 
s3mout05_1C <- lm(foreignsuff  ~ edu2*male*agex + familiarityFT_CHN*male*agex + lvpr +  
                    zip_did + sqrt(c10_sreg_fper) + I(c10_sreg_edu_ugsP/10) + 
                    didper + sqrt(c10_mun_fper) + I(c10_mun_edu_ugsP/10) + 
                    as.factor(wave), data=sifcct)

## Mediator Model
s3mm05_1C <- lm(familiarityFT_CHN  ~ edu2*male*agex + lvpr +  
                  zip_did + sqrt(c10_sreg_fper) + I(c10_sreg_edu_ugsP/10) + 
                  didper + sqrt(c10_mun_fper) + I(c10_mun_edu_ugsP/10) + 
                  as.factor(wave), data=sifcct)

## Table
screenreg(list(s3mm05_1C,s3mout05_1C), digits = 4, single.row = T,
          override.se = list(coeftest(s3mm05_1C,vcov.=vcovHC(s3mm05_1C))[,2],
                             coeftest(s3mout05_1C,vcov.=vcovHC(s3mout05_1C))[,2]),
          override.pvalues = list(coeftest(s3mm05_1C,vcov.=vcovHC(s3mm05_1C))[,4],
                                  coeftest(s3mout05_1C,vcov.=vcovHC(s3mout05_1C))[,4]),
          omit.coef = "(wave)", stars = c(0.1,0.05,0.01,0.001), symbol = "+",
          custom.coef.map = vnmap, 
          custom.model.names = c("Mediator","Outcome"))

#+ include = FALSE, eval = FALSE
texreg(list(s3mm05_1C,s3mout05_1C), digits = 4, single.row = T,
       override.se = list(coeftest(s3mm05_1C,vcov.=vcovHC(s3mm05_1C))[,2],
                          coeftest(s3mout05_1C,vcov.=vcovHC(s3mout05_1C))[,2]),
       override.pvalues = list(coeftest(s3mm05_1C,vcov.=vcovHC(s3mm05_1C))[,4],
                               coeftest(s3mout05_1C,vcov.=vcovHC(s3mout05_1C))[,4]),
       ...
       custom.model.names = c("Mediator","Outcome"),
       booktabs = TRUE, dcolumn = TRUE, use.packages = FALSE, table = FALSE, fontsize = "scriptsize",
       file = paste0(projdir,"/out/s3medout05_1_tabular.tex"))
...
## Female
medout05_f25 <- mediate(s3mm05_1C, s3mout05_1C, treat = "edu2", 
                        mediator = "familiarityFT_CHN", 
                        covariates = list(male = 0, agex = -2), robustSE = TRUE)
summary(medout05_f25)
medout05_f35 <- mediate(s3mm05_1C, s3mout05_1C, treat = "edu2", 
                        mediator = "familiarityFT_CHN", 
                        covariates = list(male = 0, agex = -1), robustSE = TRUE)
summary(medout05_f35)
medout05_f45 <- mediate(s3mm05_1C, s3mout05_1C, treat = "edu2", 
                        mediator = "familiarityFT_CHN", 
                        covariates = list(male = 0, agex = 0), robustSE = TRUE)
summary(medout05_f45)
medout05_f55 <- mediate(s3mm05_1C, s3mout05_1C, treat = "edu2", 
                        mediator = "familiarityFT_CHN", 
                        covariates = list(male = 0, agex = 1), robustSE = TRUE)
summary(medout05_f55)
medout05_f65 <- mediate(s3mm05_1C, s3mout05_1C, treat = "edu2", 
                        mediator = "familiarityFT_CHN", 
                        covariates = list(male = 0, agex = 2), robustSE = TRUE)
summary(medout05_f65)
## Male
medout05_m25 <- mediate(s3mm05_1C, s3mout05_1C, treat = "edu2", 
                        mediator = "familiarityFT_CHN", 
                        covariates = list(male = 1, agex = -2), robustSE = TRUE)
summary(medout05_m25)
medout05_m35 <- mediate(s3mm05_1C, s3mout05_1C, treat = "edu2", 
                        mediator = "familiarityFT_CHN", 
                        covariates = list(male = 1, agex = -1), robustSE = TRUE)
summary(medout05_m35)
medout05_m45 <- mediate(s3mm05_1C, s3mout05_1C, treat = "edu2", 
                        mediator = "familiarityFT_CHN", 
                        covariates = list(male = 1, agex = 0), robustSE = TRUE)
summary(medout05_m45)
medout05_m55 <- mediate(s3mm05_1C, s3mout05_1C, treat = "edu2", 
                        mediator = "familiarityFT_CHN", 
                        covariates = list(male = 1, agex = 1), robustSE = TRUE)
summary(medout05_m55)
medout05_m65 <- mediate(s3mm05_1C, s3mout05_1C, treat = "edu2", 
                        mediator = "familiarityFT_CHN", 
                        covariates = list(male = 1, agex = 2), robustSE = TRUE)
...
## Outcome Model 
s3mout06_1C <- lm(foreignsuff  ~ edu2*male*agex + familiarityFT_USA*male*agex + lvpr +  
                    zip_did + sqrt(c10_sreg_fper) + I(c10_sreg_edu_ugsP/10) + 
                    didper + sqrt(c10_mun_fper) + I(c10_mun_edu_ugsP/10) + 
                    as.factor(wave), data=sifcct)

## Mediator Model
s3mm06_1C <- lm(familiarityFT_USA  ~ edu2*male*agex + lvpr +  
                  zip_did + sqrt(c10_sreg_fper) + I(c10_sreg_edu_ugsP/10) + 
                  didper + sqrt(c10_mun_fper) + I(c10_mun_edu_ugsP/10) + 
                  as.factor(wave), data=sifcct)

## Table
screenreg(list(s3mm06_1C,s3mout06_1C), digits = 4, single.row = T,
          override.se = list(coeftest(s3mm06_1C,vcov.=vcovHC(s3mm06_1C))[,2],
                             coeftest(s3mout06_1C,vcov.=vcovHC(s3mout06_1C))[,2]),
          override.pvalues = list(coeftest(s3mm06_1C,vcov.=vcovHC(s3mm06_1C))[,4],
                                  coeftest(s3mout06_1C,vcov.=vcovHC(s3mout06_1C))[,4]),
          omit.coef = "(wave)", stars = c(0.1,0.05,0.01,0.001), symbol = "+",
          custom.coef.map = vnmap, 
          custom.model.names = c("Mediator","Outcome"))

#+ include = FALSE, eval = FALSE
texreg(list(s3mm06_1C,s3mout06_1C), digits = 4, single.row = T,
       override.se = list(coeftest(s3mm06_1C,vcov.=vcovHC(s3mm06_1C))[,2],
                          coeftest(s3mout06_1C,vcov.=vcovHC(s3mout06_1C))[,2]),
       override.pvalues = list(coeftest(s3mm06_1C,vcov.=vcovHC(s3mm06_1C))[,4],
                               coeftest(s3mout06_1C,vcov.=vcovHC(s3mout06_1C))[,4]),
       ...
       custom.model.names = c("Mediator","Outcome"),
       booktabs = TRUE, dcolumn = TRUE, use.packages = FALSE, table = FALSE, fontsize = "scriptsize",
       file = paste0(projdir,"/out/s3medout06_1_tabular.tex"))
...
## Female
medout06_f25 <- mediate(s3mm06_1C, s3mout06_1C, treat = "edu2", 
                        mediator = "familiarityFT_USA", 
                        covariates = list(male = 0, agex = -2), robustSE = TRUE)
summary(medout06_f25)
medout06_f35 <- mediate(s3mm06_1C, s3mout06_1C, treat = "edu2", 
                        mediator = "familiarityFT_USA", 
                        covariates = list(male = 0, agex = -1), robustSE = TRUE)
summary(medout06_f35)
medout06_f45 <- mediate(s3mm06_1C, s3mout06_1C, treat = "edu2", 
                        mediator = "familiarityFT_USA", 
                        covariates = list(male = 0, agex = 0), robustSE = TRUE)
summary(medout06_f45)
medout06_f55 <- mediate(s3mm06_1C, s3mout06_1C, treat = "edu2", 
                        mediator = "familiarityFT_USA", 
                        covariates = list(male = 0, agex = 1), robustSE = TRUE)
summary(medout06_f55)
medout06_f65 <- mediate(s3mm06_1C, s3mout06_1C, treat = "edu2", 
                        mediator = "familiarityFT_USA", 
                        covariates = list(male = 0, agex = 2), robustSE = TRUE)
summary(medout06_f65)
## Male
medout06_m25 <- mediate(s3mm06_1C, s3mout06_1C, treat = "edu2", 
                        mediator = "familiarityFT_USA", 
                        covariates = list(male = 1, agex = -2), robustSE = TRUE)
summary(medout06_m25)
medout06_m35 <- mediate(s3mm06_1C, s3mout06_1C, treat = "edu2", 
                        mediator = "familiarityFT_USA", 
                        covariates = list(male = 1, agex = -1), robustSE = TRUE)
summary(medout06_m35)
medout06_m45 <- mediate(s3mm06_1C, s3mout06_1C, treat = "edu2", 
                        mediator = "familiarityFT_USA", 
                        covariates = list(male = 1, agex = 0), robustSE = TRUE)
summary(medout06_m45)
medout06_m55 <- mediate(s3mm06_1C, s3mout06_1C, treat = "edu2", 
                        mediator = "familiarityFT_USA", 
                        covariates = list(male = 1, agex = 1), robustSE = TRUE)
summary(medout06_m55)
medout06_m65 <- mediate(s3mm06_1C, s3mout06_1C, treat = "edu2", 
                        mediator = "familiarityFT_USA", 
                        covariates = list(male = 1, agex = 2), robustSE = TRUE)
...
## Outcome Model 
s3mout07_1C <- lm(foreignsuff  ~ edu2*male*agex + income*male*agex + lvpr +  
                    zip_did + sqrt(c10_sreg_fper) + I(c10_sreg_edu_ugsP/10) + 
                    didper + sqrt(c10_mun_fper) + I(c10_mun_edu_ugsP/10) + 
                    as.factor(wave), data=sifcct)

## Mediator Model
s3mm07_1C <- lm(income  ~ edu2*male*agex + lvpr +  
                  zip_did + sqrt(c10_sreg_fper) + I(c10_sreg_edu_ugsP/10) + 
                  didper + sqrt(c10_mun_fper) + I(c10_mun_edu_ugsP/10) + 
                  as.factor(wave), data=sifcct)

## Table
screenreg(list(s3mm07_1C,s3mout07_1C), digits = 4, single.row = T,
          override.se = list(coeftest(s3mm07_1C,vcov.=vcovHC(s3mm07_1C))[,2],
                             coeftest(s3mout07_1C,vcov.=vcovHC(s3mout07_1C))[,2]),
          override.pvalues = list(coeftest(s3mm07_1C,vcov.=vcovHC(s3mm07_1C))[,4],
                                  coeftest(s3mout07_1C,vcov.=vcovHC(s3mout07_1C))[,4]),
          omit.coef = "(wave)", stars = c(0.1,0.05,0.01,0.001), symbol = "+",
          custom.coef.map = vnmap, 
          custom.model.names = c("Mediator","Outcome"))

#+ include = FALSE, eval = FALSE
texreg(list(s3mm07_1C,s3mout07_1C), digits = 4, single.row = T,
       override.se = list(coeftest(s3mm07_1C,vcov.=vcovHC(s3mm07_1C))[,2],
                          coeftest(s3mout07_1C,vcov.=vcovHC(s3mout07_1C))[,2]),
       override.pvalues = list(coeftest(s3mm07_1C,vcov.=vcovHC(s3mm07_1C))[,4],
                               coeftest(s3mout07_1C,vcov.=vcovHC(s3mout07_1C))[,4]),
       ...
       custom.model.names = c("Mediator","Outcome"),
       booktabs = TRUE, dcolumn = TRUE, use.packages = FALSE, table = FALSE, fontsize = "scriptsize",
       file = paste0(projdir,"/out/s3medout07_1_tabular.tex"))
...
## Female
medout07_f25 <- mediate(s3mm07_1C, s3mout07_1C, treat = "edu2", 
                        mediator = "income", 
                        covariates = list(male = 0, agex = -2), robustSE = TRUE)
summary(medout07_f25)
medout07_f35 <- mediate(s3mm07_1C, s3mout07_1C, treat = "edu2", 
                        mediator = "income", 
                        covariates = list(male = 0, agex = -1), robustSE = TRUE)
summary(medout07_f35)
medout07_f45 <- mediate(s3mm07_1C, s3mout07_1C, treat = "edu2", 
                        mediator = "income", 
                        covariates = list(male = 0, agex = 0), robustSE = TRUE)
summary(medout07_f45)
medout07_f55 <- mediate(s3mm07_1C, s3mout07_1C, treat = "edu2", 
                        mediator = "income", 
                        covariates = list(male = 0, agex = 1), robustSE = TRUE)
summary(medout07_f55)
medout07_f65 <- mediate(s3mm07_1C, s3mout07_1C, treat = "edu2", 
                        mediator = "income", 
                        covariates = list(male = 0, agex = 2), robustSE = TRUE)
summary(medout07_f65)
## Male
medout07_m25 <- mediate(s3mm07_1C, s3mout07_1C, treat = "edu2", 
                        mediator = "income", 
                        covariates = list(male = 1, agex = -2), robustSE = TRUE)
summary(medout07_m25)
medout07_m35 <- mediate(s3mm07_1C, s3mout07_1C, treat = "edu2", 
                        mediator = "income", 
                        covariates = list(male = 1, agex = -1), robustSE = TRUE)
summary(medout07_m35)
medout07_m45 <- mediate(s3mm07_1C, s3mout07_1C, treat = "edu2", 
                        mediator = "income", 
                        covariates = list(male = 1, agex = 0), robustSE = TRUE)
summary(medout07_m45)
medout07_m55 <- mediate(s3mm07_1C, s3mout07_1C, treat = "edu2", 
                        mediator = "income", 
                        covariates = list(male = 1, agex = 1), robustSE = TRUE)
summary(medout07_m55)
medout07_m65 <- mediate(s3mm07_1C, s3mout07_1C, treat = "edu2", 
                        mediator = "income", 
                        covariates = list(male = 1, agex = 2), robustSE = TRUE)
...
#+ eval=FALSE
save.image(paste0(projdir,"/out/heavy/analysis_6_mediation_matchedL100_v5.RData"))
load(paste0(projdir,"/out/heavy/analysis_6_mediation_matchedL100_v5.RData"))
...
coefdt$lambda <- "Matched with Lambda = 100km"
...
saveRDS(coefdt, paste0(projdir,"/out/medoutcoefdt_matchedL100_v5.rds"))

#+ echo=FALSE
coefdt <- readRDS(paste0(projdir,"/out/medoutcoefdt_matchedL100_v5.rds"))
...
ggsave(paste0(projdir,"/out/mediationplot_knowledge_matchedL100_v5.png"),p,width=8,height=5)
...
ggsave(paste0(projdir,"/out/mediationplot2_knowledge_matchedL100_v5.png"),p,width=8,height=5)
...
ggsave(paste0(projdir,"/out/mediationplot_ideology_matchedL100_v5.png"),p,width=8,height=5)
...
ggsave(paste0(projdir,"/out/mediationplot2_ideology_matchedL100_v5.png"),p,width=8,height=5)
...
ggsave(paste0(projdir,"/out/mediationplot_ldpdpjft_matchedL100_v5.png"),p,width=8,height=5)
...
ggsave(paste0(projdir,"/out/mediationplot2_ldpdpjft_matchedL100_v5.png"),p,width=8,height=5)
...
ggsave(paste0(projdir,"/out/mediationplot_familiarityFT_KOR_matchedL100_v5.png"),p,width=8,height=5)
...
ggsave(paste0(projdir,"/out/mediationplot2_familiarityFT_KOR_matchedL100_v5.png"),p,width=8,height=5)
...
ggsave(paste0(projdir,"/out/mediationplot_familiarityFT_CHN_matchedL100_v5.png"),p,width=8,height=5)
...
ggsave(paste0(projdir,"/out/mediationplot2_familiarityFT_CHN_matchedL100_v5.png"),p,width=8,height=5)
...
ggsave(paste0(projdir,"/out/mediationplot_familiarityFT_USA_matchedL100_v5.png"),p,width=8,height=5)
...
ggsave(paste0(projdir,"/out/mediationplot2_familiarityFT_USA_matchedL100_v5.png"),p,width=8,height=5)
...
ggsave(paste0(projdir,"/out/mediationplot_income_matchedL100_v5.png"),p,width=8,height=5)
...
ggsave(paste0(projdir,"/out/mediationplot2_income_matchedL100_v5.png"),p,width=8,height=5)

#+ eval=FALSE, echo=FALSE
# Exporting HTML File
# In R Studio
# rmarkdown::render('./src/analysis_6_mediation_matchedL100_v5.R', rmarkdown::pdf_document(latex_engine="xelatex", extra_dependencies = list(bookmark=NULL, xltxtra=NULL, zxjatype=NULL, zxjafont=c("ipa"))), encoding = 'UTF-8')
# rmarkdown::render('./src/analysis_6_mediation_matchedL100_v5.R', 'github_document', clean=FALSE)
