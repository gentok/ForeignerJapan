#' ---
#' title: "Analysis 7: Mediation Analysis with Left Party Support"
...
# Exporting HTML File
# In R Studio
# rmarkdown::render('./src/analysis_7_mediationLPS_v4.R', 'github_document', clean=FALSE)
...
# Rscript -e "rmarkdown::render('analysis_7_mediationLPS_v4.R', 'github_document', clean=FALSE)"
