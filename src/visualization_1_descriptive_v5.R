#' ---
#' title: "Visualization 1: Descriptive Statistics"
...
# Exporting HTML File
# In R Studio
# rmarkdown::render('./src/visualization_1_descriptive_v5.R', rmarkdown::pdf_document(latex_engine="xelatex", extra_dependencies = list(bookmark=NULL, xltxtra=NULL, zxjatype=NULL, zxjafont=c("ipa"))), encoding = 'UTF-8')
# rmarkdown::render('./src/visualization_1_descriptive_v5.R', 'github_document', clean=FALSE)
