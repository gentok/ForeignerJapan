...
# Exporting HTML File
# In R Studio
# rmarkdown::render('./src/analysis_0_descriptives_v4.R', 'github_document', clean=FALSE)
...
# Rscript -e "rmarkdown::render('analysis_0_descriptives_v4.R', 'github_document', clean=FALSE)"
