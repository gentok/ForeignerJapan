#' ---
#' title: "Analysis 5: Mediation Analysis with LDP Feeling Thermometer"
...
# Exporting HTML File
# In R Studio
# rmarkdown::render('./src/analysis_5_mediationLDP_v4.R', 'github_document', clean=FALSE)
...
# Rscript -e "rmarkdown::render('analysis_5_mediationLDP_v4.R', 'github_document', clean=FALSE)"
