...
\hypersetup{
  pdftitle={Analysis 2: Main Analysis with Unmatched and Matched Data},
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{sifcct <-}\StringTok{ }\KeywordTok{readRDS}\NormalTok{(datadir0)}
...
\NormalTok{s0mo_1C <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(foreignsuff }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodC), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\KeywordTok{screenreg}\NormalTok{(}\KeywordTok{list}\NormalTok{(s0mo_}\DecValTok{10}\NormalTok{,s0mo_1A,s0mo_1B,s0mo_1C), }\DataTypeTok{digits =} \DecValTok{4}\NormalTok{, }\CommentTok{#single.row = T,}
          \DataTypeTok{override.se =} \KeywordTok{list}\NormalTok{(}\KeywordTok{coeftest}\NormalTok{(s0mo_}\DecValTok{10}\NormalTok{,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s0mo_}\DecValTok{10}\NormalTok{))[,}\DecValTok{2}\NormalTok{],}
...
\NormalTok{outdt0 <-}\StringTok{ }\KeywordTok{rbind}\NormalTok{(}\KeywordTok{extout}\NormalTok{(}\StringTok{"Female"}\NormalTok{,}\DecValTok{25}\NormalTok{),}
                \KeywordTok{extout}\NormalTok{(}\StringTok{"Female"}\NormalTok{,}\DecValTok{35}\NormalTok{),}
                \KeywordTok{extout}\NormalTok{(}\StringTok{"Female"}\NormalTok{,}\DecValTok{45}\NormalTok{),}
                \KeywordTok{extout}\NormalTok{(}\StringTok{"Female"}\NormalTok{,}\DecValTok{55}\NormalTok{),}
                \KeywordTok{extout}\NormalTok{(}\StringTok{"Female"}\NormalTok{,}\DecValTok{65}\NormalTok{),}
                \KeywordTok{extout}\NormalTok{(}\StringTok{"Male"}\NormalTok{,}\DecValTok{25}\NormalTok{),}
                \KeywordTok{extout}\NormalTok{(}\StringTok{"Male"}\NormalTok{,}\DecValTok{35}\NormalTok{),}
                \KeywordTok{extout}\NormalTok{(}\StringTok{"Male"}\NormalTok{,}\DecValTok{45}\NormalTok{),}
                \KeywordTok{extout}\NormalTok{(}\StringTok{"Male"}\NormalTok{,}\DecValTok{55}\NormalTok{),}
                \KeywordTok{extout}\NormalTok{(}\StringTok{"Male"}\NormalTok{,}\DecValTok{65}\NormalTok{))}
...
\CommentTok{# require(nnet)}
\CommentTok{# s0mo2_10 <- multinom(update(foreignsuff3x ~ ., basemod0), data=sifcct[which(sifcct$age - sifcct$lvlen<=15),])}
\CommentTok{# s0mo2_1A <- multinom(update(foreignsuff3x ~ ., basemodA), data=sifcct[which(sifcct$age - sifcct$lvlen<=15),])}
\CommentTok{# s0mo2_1B <- multinom(update(foreignsuff3x ~ ., basemodB), data=sifcct[which(sifcct$age - sifcct$lvlen<=15),])}
\CommentTok{# s0mo2_1C <- multinom(update(foreignsuff3x ~ ., basemodC), data=sifcct[which(sifcct$age - sifcct$lvlen<=15),])}
...
\NormalTok{s0mo2_}\DecValTok{10}\NormalTok{ <-}\StringTok{ }\KeywordTok{mlogit}\NormalTok{(outmod0.mlogit, }\DataTypeTok{data=}\NormalTok{sifcct.mlogit, }\DataTypeTok{reflevel=}\StringTok{"Disagree"}\NormalTok{)}
\NormalTok{s0mo2_1A <-}\StringTok{ }\KeywordTok{mlogit}\NormalTok{(outmodA.mlogit, }\DataTypeTok{data=}\NormalTok{sifcct.mlogit, }\DataTypeTok{reflevel=}\StringTok{"Disagree"}\NormalTok{)}
\NormalTok{s0mo2_1B <-}\StringTok{ }\KeywordTok{mlogit}\NormalTok{(outmodB.mlogit, }\DataTypeTok{data=}\NormalTok{sifcct.mlogit, }\DataTypeTok{reflevel=}\StringTok{"Disagree"}\NormalTok{)}
\NormalTok{s0mo2_1C <-}\StringTok{ }\KeywordTok{mlogit}\NormalTok{(outmodC.mlogit, }\DataTypeTok{data=}\NormalTok{sifcct.mlogit, }\DataTypeTok{reflevel=}\StringTok{"Disagree"}\NormalTok{)}
...
\NormalTok{outdt0m <-}\StringTok{ }\KeywordTok{rbind}\NormalTok{(}\KeywordTok{extout}\NormalTok{(}\StringTok{"Female"}\NormalTok{,}\DecValTok{25}\NormalTok{,}\DecValTok{1}\NormalTok{),}
...
\NormalTok{outdt0m <-}\StringTok{ }\KeywordTok{as.data.frame}\NormalTok{(outdt0m)}
\ControlFlowTok{for}\NormalTok{(i }\ControlFlowTok{in} \DecValTok{2}\OperatorTok{:}\DecValTok{9}\NormalTok{) outdt0m[,i] <-}\StringTok{ }\KeywordTok{as.numeric}\NormalTok{(outdt0m[,i])}
\NormalTok{outdt0m}\OperatorTok{$}\NormalTok{gender <-}\StringTok{ }\KeywordTok{factor}\NormalTok{(outdt0m}\OperatorTok{$}\NormalTok{gender, }\DataTypeTok{levels=}\KeywordTok{unique}\NormalTok{(outdt0m}\OperatorTok{$}\NormalTok{gender))}
\KeywordTok{summary}\NormalTok{(outdt0m)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{s0mm03_}\DecValTok{10}\NormalTok{ <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(ldpdpjft }\OperatorTok{~}\StringTok{ }\NormalTok{., basemod0), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s0mm03_1A <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(ldpdpjft }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodA), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s0mm03_1B <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(ldpdpjft }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodB), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s0mm03_1C <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(ldpdpjft }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodC), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\KeywordTok{screenreg}\NormalTok{(}\KeywordTok{list}\NormalTok{(s0mm03_}\DecValTok{10}\NormalTok{,s0mm03_1A,s0mm03_1B,s0mm03_1C), }\DataTypeTok{digits =} \DecValTok{4}\NormalTok{, }\CommentTok{#single.row = T,}
          \DataTypeTok{override.se =} \KeywordTok{list}\NormalTok{(}\KeywordTok{coeftest}\NormalTok{(s0mm03_}\DecValTok{10}\NormalTok{,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s0mm03_}\DecValTok{10}\NormalTok{))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s0mm03_1A,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s0mm03_1A))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s0mm03_1B,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s0mm03_1B))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s0mm03_1C,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s0mm03_1C))[,}\DecValTok{2}\NormalTok{]),}
...
\NormalTok{s1mo_}\DecValTok{10}\NormalTok{ <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(foreignsuff }\OperatorTok{~}\StringTok{ }\NormalTok{., basemod0), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s1mo_1A <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(foreignsuff }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodA), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s1mo_1B <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(foreignsuff }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodB), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s1mo_1C <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(foreignsuff }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodC), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\KeywordTok{screenreg}\NormalTok{(}\KeywordTok{list}\NormalTok{(s1mo_}\DecValTok{10}\NormalTok{,s1mo_1A,s1mo_1B,s1mo_1C), }\DataTypeTok{digits =} \DecValTok{4}\NormalTok{, }\CommentTok{#single.row = T,}
          \DataTypeTok{override.se =} \KeywordTok{list}\NormalTok{(}\KeywordTok{coeftest}\NormalTok{(s1mo_}\DecValTok{10}\NormalTok{,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s1mo_}\DecValTok{10}\NormalTok{))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s1mo_1A,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s1mo_1A))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s1mo_1B,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s1mo_1B))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s1mo_1C,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s1mo_1C))[,}\DecValTok{2}\NormalTok{]),}
...
\NormalTok{outdt1 <-}\StringTok{ }\KeywordTok{rbind}\NormalTok{(}\KeywordTok{extout}\NormalTok{(}\StringTok{"Female"}\NormalTok{,}\DecValTok{25}\NormalTok{),}
                \KeywordTok{extout}\NormalTok{(}\StringTok{"Female"}\NormalTok{,}\DecValTok{35}\NormalTok{),}
                \KeywordTok{extout}\NormalTok{(}\StringTok{"Female"}\NormalTok{,}\DecValTok{45}\NormalTok{),}
                \KeywordTok{extout}\NormalTok{(}\StringTok{"Female"}\NormalTok{,}\DecValTok{55}\NormalTok{),}
                \KeywordTok{extout}\NormalTok{(}\StringTok{"Female"}\NormalTok{,}\DecValTok{65}\NormalTok{),}
                ...
                \KeywordTok{extout}\NormalTok{(}\StringTok{"Male"}\NormalTok{,}\DecValTok{55}\NormalTok{),}
                \KeywordTok{extout}\NormalTok{(}\StringTok{"Male"}\NormalTok{,}\DecValTok{65}\NormalTok{))}
\NormalTok{outdt1 <-}\StringTok{ }\KeywordTok{as.data.frame}\NormalTok{(outdt1)}
\ControlFlowTok{for}\NormalTok{(i }\ControlFlowTok{in} \DecValTok{2}\OperatorTok{:}\DecValTok{9}\NormalTok{) outdt1[,i] <-}\StringTok{ }\KeywordTok{as.numeric}\NormalTok{(outdt1[,i])}
\NormalTok{outdt1}\OperatorTok{$}\NormalTok{gender <-}\StringTok{ }\KeywordTok{factor}\NormalTok{(outdt1}\OperatorTok{$}\NormalTok{gender, }\DataTypeTok{levels=}\KeywordTok{unique}\NormalTok{(outdt1}\OperatorTok{$}\NormalTok{gender))}
\KeywordTok{summary}\NormalTok{(outdt1)}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{# require(nnet)}
\CommentTok{# s1mo2_10 <- multinom(update(foreignsuff3x ~ ., basemod0), data=sifcct[which(sifcct$age - sifcct$lvlen<=15),])}
\CommentTok{# s1mo2_1A <- multinom(update(foreignsuff3x ~ ., basemodA), data=sifcct[which(sifcct$age - sifcct$lvlen<=15),])}
\CommentTok{# s1mo2_1B <- multinom(update(foreignsuff3x ~ ., basemodB), data=sifcct[which(sifcct$age - sifcct$lvlen<=15),])}
\CommentTok{# s1mo2_1C <- multinom(update(foreignsuff3x ~ ., basemodC), data=sifcct[which(sifcct$age - sifcct$lvlen<=15),])}

\NormalTok{sifcct.mlogit <-}\StringTok{ }\KeywordTok{dfidx}\NormalTok{(sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),],}
                       \DataTypeTok{shape =} \StringTok{"wide"}\NormalTok{, }\DataTypeTok{choice =} \StringTok{"foreignsuff3x"}\NormalTok{)}
\CommentTok{# # levels(sifcct.mlogit$idx$id2) <- c("Disagree","Neither","Agree")}
\NormalTok{s1mo2_}\DecValTok{10}\NormalTok{ <-}\StringTok{ }\KeywordTok{mlogit}\NormalTok{(outmod0.mlogit, }\DataTypeTok{data=}\NormalTok{sifcct.mlogit, }\DataTypeTok{reflevel=}\StringTok{"Disagree"}\NormalTok{)}
\NormalTok{s1mo2_1A <-}\StringTok{ }\KeywordTok{mlogit}\NormalTok{(outmodA.mlogit, }\DataTypeTok{data=}\NormalTok{sifcct.mlogit, }\DataTypeTok{reflevel=}\StringTok{"Disagree"}\NormalTok{)}
\NormalTok{s1mo2_1B <-}\StringTok{ }\KeywordTok{mlogit}\NormalTok{(outmodB.mlogit, }\DataTypeTok{data=}\NormalTok{sifcct.mlogit, }\DataTypeTok{reflevel=}\StringTok{"Disagree"}\NormalTok{)}
\NormalTok{s1mo2_1C <-}\StringTok{ }\KeywordTok{mlogit}\NormalTok{(outmodC.mlogit, }\DataTypeTok{data=}\NormalTok{sifcct.mlogit, }\DataTypeTok{reflevel=}\StringTok{"Disagree"}\NormalTok{)}
...
\NormalTok{outdt1m <-}\StringTok{ }\KeywordTok{rbind}\NormalTok{(}\KeywordTok{extout}\NormalTok{(}\StringTok{"Female"}\NormalTok{,}\DecValTok{25}\NormalTok{,}\DecValTok{1}\NormalTok{),}
                 \KeywordTok{extout}\NormalTok{(}\StringTok{"Female"}\NormalTok{,}\DecValTok{35}\NormalTok{,}\DecValTok{1}\NormalTok{),}
                 \KeywordTok{extout}\NormalTok{(}\StringTok{"Female"}\NormalTok{,}\DecValTok{45}\NormalTok{,}\DecValTok{1}\NormalTok{),}
                 \KeywordTok{extout}\NormalTok{(}\StringTok{"Female"}\NormalTok{,}\DecValTok{55}\NormalTok{,}\DecValTok{1}\NormalTok{),}
                 \KeywordTok{extout}\NormalTok{(}\StringTok{"Female"}\NormalTok{,}\DecValTok{65}\NormalTok{,}\DecValTok{1}\NormalTok{),}
                 ...
                 \KeywordTok{extout}\NormalTok{(}\StringTok{"Male"}\NormalTok{,}\DecValTok{55}\NormalTok{,}\DecValTok{1}\NormalTok{),}
                 \KeywordTok{extout}\NormalTok{(}\StringTok{"Male"}\NormalTok{,}\DecValTok{65}\NormalTok{,}\DecValTok{1}\NormalTok{))}
\NormalTok{outdt1m <-}\StringTok{ }\KeywordTok{as.data.frame}\NormalTok{(outdt1m)}
\ControlFlowTok{for}\NormalTok{(i }\ControlFlowTok{in} \DecValTok{2}\OperatorTok{:}\DecValTok{9}\NormalTok{) outdt1m[,i] <-}\StringTok{ }\KeywordTok{as.numeric}\NormalTok{(outdt1m[,i])}
\NormalTok{outdt1m}\OperatorTok{$}\NormalTok{gender <-}\StringTok{ }\KeywordTok{factor}\NormalTok{(outdt1m}\OperatorTok{$}\NormalTok{gender, }\DataTypeTok{levels=}\KeywordTok{unique}\NormalTok{(outdt1m}\OperatorTok{$}\NormalTok{gender))}
\KeywordTok{summary}\NormalTok{(outdt1m)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{s1mm01_}\DecValTok{10}\NormalTok{ <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(knowledge }\OperatorTok{~}\StringTok{ }\NormalTok{., basemod0), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s1mm01_1A <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(knowledge }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodA), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s1mm01_1B <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(knowledge }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodB), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s1mm01_1C <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(knowledge }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodC), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\KeywordTok{screenreg}\NormalTok{(}\KeywordTok{list}\NormalTok{(s1mm01_}\DecValTok{10}\NormalTok{,s1mm01_1A,s1mm01_1B,s1mm01_1C), }\DataTypeTok{digits =} \DecValTok{4}\NormalTok{, }\CommentTok{#single.row = T,}
          \DataTypeTok{override.se =} \KeywordTok{list}\NormalTok{(}\KeywordTok{coeftest}\NormalTok{(s1mm01_}\DecValTok{10}\NormalTok{,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s1mm01_}\DecValTok{10}\NormalTok{))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s1mm01_1A,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s1mm01_1A))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s1mm01_1B,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s1mm01_1B))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s1mm01_1C,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s1mm01_1C))[,}\DecValTok{2}\NormalTok{]),}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{s1mm02_}\DecValTok{10}\NormalTok{ <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(ideology }\OperatorTok{~}\StringTok{ }\NormalTok{., basemod0), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s1mm02_1A <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(ideology }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodA), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s1mm02_1B <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(ideology }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodB), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s1mm02_1C <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(ideology }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodC), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\KeywordTok{screenreg}\NormalTok{(}\KeywordTok{list}\NormalTok{(s1mm02_}\DecValTok{10}\NormalTok{,s1mm02_1A,s1mm02_1B,s1mm02_1C), }\DataTypeTok{digits =} \DecValTok{4}\NormalTok{, }\CommentTok{#single.row = T,}
          \DataTypeTok{override.se =} \KeywordTok{list}\NormalTok{(}\KeywordTok{coeftest}\NormalTok{(s1mm02_}\DecValTok{10}\NormalTok{,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s1mm02_}\DecValTok{10}\NormalTok{))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s1mm02_1A,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s1mm02_1A))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s1mm02_1B,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s1mm02_1B))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s1mm02_1C,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s1mm02_1C))[,}\DecValTok{2}\NormalTok{]),}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{s1mm03_}\DecValTok{10}\NormalTok{ <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(ldpdpjft }\OperatorTok{~}\StringTok{ }\NormalTok{., basemod0), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s1mm03_1A <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(ldpdpjft }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodA), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s1mm03_1B <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(ldpdpjft }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodB), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s1mm03_1C <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(ldpdpjft }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodC), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\KeywordTok{screenreg}\NormalTok{(}\KeywordTok{list}\NormalTok{(s1mm03_}\DecValTok{10}\NormalTok{,s1mm03_1A,s1mm03_1B,s1mm03_1C), }\DataTypeTok{digits =} \DecValTok{4}\NormalTok{, }\CommentTok{#single.row = T,}
          \DataTypeTok{override.se =} \KeywordTok{list}\NormalTok{(}\KeywordTok{coeftest}\NormalTok{(s1mm03_}\DecValTok{10}\NormalTok{,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s1mm03_}\DecValTok{10}\NormalTok{))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s1mm03_1A,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s1mm03_1A))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s1mm03_1B,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s1mm03_1B))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s1mm03_1C,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s1mm03_1C))[,}\DecValTok{2}\NormalTok{]),}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{s1mm04_}\DecValTok{10}\NormalTok{ <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_KOR }\OperatorTok{~}\StringTok{ }\NormalTok{., basemod0), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s1mm04_1A <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_KOR }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodA), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s1mm04_1B <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_KOR }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodB), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s1mm04_1C <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_KOR }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodC), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\KeywordTok{screenreg}\NormalTok{(}\KeywordTok{list}\NormalTok{(s1mm04_}\DecValTok{10}\NormalTok{,s1mm04_1A,s1mm04_1B,s1mm04_1C), }\DataTypeTok{digits =} \DecValTok{4}\NormalTok{, }\CommentTok{#single.row = T,}
          \DataTypeTok{override.se =} \KeywordTok{list}\NormalTok{(}\KeywordTok{coeftest}\NormalTok{(s1mm04_}\DecValTok{10}\NormalTok{,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s1mm04_}\DecValTok{10}\NormalTok{))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s1mm04_1A,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s1mm04_1A))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s1mm04_1B,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s1mm04_1B))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s1mm04_1C,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s1mm04_1C))[,}\DecValTok{2}\NormalTok{]),}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{s1mm05_}\DecValTok{10}\NormalTok{ <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_CHN }\OperatorTok{~}\StringTok{ }\NormalTok{., basemod0), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s1mm05_1A <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_CHN }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodA), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s1mm05_1B <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_CHN }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodB), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s1mm05_1C <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_CHN }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodC), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\KeywordTok{screenreg}\NormalTok{(}\KeywordTok{list}\NormalTok{(s1mm05_}\DecValTok{10}\NormalTok{,s1mm05_1A,s1mm05_1B,s1mm05_1C), }\DataTypeTok{digits =} \DecValTok{4}\NormalTok{, }\CommentTok{#single.row = T,}
          \DataTypeTok{override.se =} \KeywordTok{list}\NormalTok{(}\KeywordTok{coeftest}\NormalTok{(s1mm05_}\DecValTok{10}\NormalTok{,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s1mm05_}\DecValTok{10}\NormalTok{))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s1mm05_1A,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s1mm05_1A))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s1mm05_1B,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s1mm05_1B))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s1mm05_1C,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s1mm05_1C))[,}\DecValTok{2}\NormalTok{]),}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{s1mm06_}\DecValTok{10}\NormalTok{ <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_USA }\OperatorTok{~}\StringTok{ }\NormalTok{., basemod0), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s1mm06_1A <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_USA }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodA), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s1mm06_1B <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_USA }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodB), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s1mm06_1C <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_USA }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodC), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\KeywordTok{screenreg}\NormalTok{(}\KeywordTok{list}\NormalTok{(s1mm06_}\DecValTok{10}\NormalTok{,s1mm06_1A,s1mm06_1B,s1mm06_1C), }\DataTypeTok{digits =} \DecValTok{4}\NormalTok{, }\CommentTok{#single.row = T,}
          \DataTypeTok{override.se =} \KeywordTok{list}\NormalTok{(}\KeywordTok{coeftest}\NormalTok{(s1mm06_}\DecValTok{10}\NormalTok{,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s1mm06_}\DecValTok{10}\NormalTok{))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s1mm06_1A,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s1mm06_1A))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s1mm06_1B,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s1mm06_1B))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s1mm06_1C,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s1mm06_1C))[,}\DecValTok{2}\NormalTok{]),}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{s1mm07_}\DecValTok{10}\NormalTok{ <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(income }\OperatorTok{~}\StringTok{ }\NormalTok{., basemod0), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s1mm07_1A <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(income }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodA), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s1mm07_1B <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(income }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodB), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s1mm07_1C <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(income }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodC), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\KeywordTok{screenreg}\NormalTok{(}\KeywordTok{list}\NormalTok{(s1mm07_}\DecValTok{10}\NormalTok{,s1mm07_1A,s1mm07_1B,s1mm07_1C), }\DataTypeTok{digits =} \DecValTok{4}\NormalTok{, }\CommentTok{#single.row = T,}
          \DataTypeTok{override.se =} \KeywordTok{list}\NormalTok{(}\KeywordTok{coeftest}\NormalTok{(s1mm07_}\DecValTok{10}\NormalTok{,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s1mm07_}\DecValTok{10}\NormalTok{))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s1mm07_1A,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s1mm07_1A))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s1mm07_1B,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s1mm07_1B))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s1mm07_1C,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s1mm07_1C))[,}\DecValTok{2}\NormalTok{]),}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{sifcct <-}\StringTok{ }\KeywordTok{readRDS}\NormalTok{(datadir2)}
\NormalTok{sifcct}\OperatorTok{$}\NormalTok{agex <-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{age}\OperatorTok{/}\DecValTok{10} \OperatorTok{-}\StringTok{ }\FloatTok{4.5}
\NormalTok{sifcct}\OperatorTok{$}\NormalTok{ldpdpjft <-}\StringTok{ }\NormalTok{original}\OperatorTok{$}\NormalTok{ldpdpjft[}\KeywordTok{match}\NormalTok{(}\KeywordTok{paste}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{id,sifcct}\OperatorTok{$}\NormalTok{wave),}\KeywordTok{paste}\NormalTok{(original}\OperatorTok{$}\NormalTok{id,original}\OperatorTok{$}\NormalTok{wave))]}
\KeywordTok{summary}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{ldpdpjft)}
\end{Highlighting}
...
\hypertarget{outcome-model-3}{%
\subsection{Outcome Model}\label{outcome-model-3}}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{## Living in Local ZIP since at least age 15 ##}

\NormalTok{s2mo_}\DecValTok{10}\NormalTok{ <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(foreignsuff }\OperatorTok{~}\StringTok{ }\NormalTok{., basemod0), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s2mo_1A <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(foreignsuff }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodA), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s2mo_1B <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(foreignsuff }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodB), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s2mo_1C <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(foreignsuff }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodC), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\KeywordTok{screenreg}\NormalTok{(}\KeywordTok{list}\NormalTok{(s2mo_}\DecValTok{10}\NormalTok{,s2mo_1A,s2mo_1B,s2mo_1C), }\DataTypeTok{digits =} \DecValTok{4}\NormalTok{, }\CommentTok{#single.row = T,}
          \DataTypeTok{override.se =} \KeywordTok{list}\NormalTok{(}\KeywordTok{coeftest}\NormalTok{(s2mo_}\DecValTok{10}\NormalTok{,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s2mo_}\DecValTok{10}\NormalTok{))[,}\DecValTok{2}\NormalTok{],}
...
\NormalTok{outdt2 <-}\StringTok{ }\KeywordTok{rbind}\NormalTok{(}\KeywordTok{extout}\NormalTok{(}\StringTok{"Female"}\NormalTok{,}\DecValTok{25}\NormalTok{),}
                \KeywordTok{extout}\NormalTok{(}\StringTok{"Female"}\NormalTok{,}\DecValTok{35}\NormalTok{),}
                \KeywordTok{extout}\NormalTok{(}\StringTok{"Female"}\NormalTok{,}\DecValTok{45}\NormalTok{),}
                \KeywordTok{extout}\NormalTok{(}\StringTok{"Female"}\NormalTok{,}\DecValTok{55}\NormalTok{),}
                \KeywordTok{extout}\NormalTok{(}\StringTok{"Female"}\NormalTok{,}\DecValTok{65}\NormalTok{),}
                ...
                \KeywordTok{extout}\NormalTok{(}\StringTok{"Male"}\NormalTok{,}\DecValTok{55}\NormalTok{),}
                \KeywordTok{extout}\NormalTok{(}\StringTok{"Male"}\NormalTok{,}\DecValTok{65}\NormalTok{))}
\NormalTok{outdt2 <-}\StringTok{ }\KeywordTok{as.data.frame}\NormalTok{(outdt2)}
\ControlFlowTok{for}\NormalTok{(i }\ControlFlowTok{in} \DecValTok{2}\OperatorTok{:}\DecValTok{9}\NormalTok{) outdt2[,i] <-}\StringTok{ }\KeywordTok{as.numeric}\NormalTok{(outdt2[,i])}
\NormalTok{outdt2}\OperatorTok{$}\NormalTok{gender <-}\StringTok{ }\KeywordTok{factor}\NormalTok{(outdt2}\OperatorTok{$}\NormalTok{gender, }\DataTypeTok{levels=}\KeywordTok{unique}\NormalTok{(outdt2}\OperatorTok{$}\NormalTok{gender))}
\KeywordTok{summary}\NormalTok{(outdt2)}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{# require(nnet)}
\CommentTok{# s2mo2_10 <- multinom(update(foreignsuff3x ~ ., basemod0), data=sifcct[which(sifcct$age - sifcct$lvlen<=15),])}
\CommentTok{# s2mo2_1A <- multinom(update(foreignsuff3x ~ ., basemodA), data=sifcct[which(sifcct$age - sifcct$lvlen<=15),])}
\CommentTok{# s2mo2_1B <- multinom(update(foreignsuff3x ~ ., basemodB), data=sifcct[which(sifcct$age - sifcct$lvlen<=15),])}
\CommentTok{# s2mo2_1C <- multinom(update(foreignsuff3x ~ ., basemodC), data=sifcct[which(sifcct$age - sifcct$lvlen<=15),])}

\NormalTok{sifcct.mlogit <-}\StringTok{ }\KeywordTok{dfidx}\NormalTok{(sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),],}
                       \DataTypeTok{shape =} \StringTok{"wide"}\NormalTok{, }\DataTypeTok{choice =} \StringTok{"foreignsuff3x"}\NormalTok{)}
\CommentTok{# # levels(sifcct.mlogit$idx$id2) <- c("Disagree","Neither","Agree")}
\NormalTok{s2mo2_}\DecValTok{10}\NormalTok{ <-}\StringTok{ }\KeywordTok{mlogit}\NormalTok{(outmod0.mlogit, }\DataTypeTok{data=}\NormalTok{sifcct.mlogit, }\DataTypeTok{reflevel=}\StringTok{"Disagree"}\NormalTok{)}
\NormalTok{s2mo2_1A <-}\StringTok{ }\KeywordTok{mlogit}\NormalTok{(outmodA.mlogit, }\DataTypeTok{data=}\NormalTok{sifcct.mlogit, }\DataTypeTok{reflevel=}\StringTok{"Disagree"}\NormalTok{)}
\NormalTok{s2mo2_1B <-}\StringTok{ }\KeywordTok{mlogit}\NormalTok{(outmodB.mlogit, }\DataTypeTok{data=}\NormalTok{sifcct.mlogit, }\DataTypeTok{reflevel=}\StringTok{"Disagree"}\NormalTok{)}
\NormalTok{s2mo2_1C <-}\StringTok{ }\KeywordTok{mlogit}\NormalTok{(outmodC.mlogit, }\DataTypeTok{data=}\NormalTok{sifcct.mlogit, }\DataTypeTok{reflevel=}\StringTok{"Disagree"}\NormalTok{)}
...
\NormalTok{outdt2m <-}\StringTok{ }\KeywordTok{rbind}\NormalTok{(}\KeywordTok{extout}\NormalTok{(}\StringTok{"Female"}\NormalTok{,}\DecValTok{25}\NormalTok{,}\DecValTok{1}\NormalTok{),}
                 \KeywordTok{extout}\NormalTok{(}\StringTok{"Female"}\NormalTok{,}\DecValTok{35}\NormalTok{,}\DecValTok{1}\NormalTok{),}
                 \KeywordTok{extout}\NormalTok{(}\StringTok{"Female"}\NormalTok{,}\DecValTok{45}\NormalTok{,}\DecValTok{1}\NormalTok{),}
                 \KeywordTok{extout}\NormalTok{(}\StringTok{"Female"}\NormalTok{,}\DecValTok{55}\NormalTok{,}\DecValTok{1}\NormalTok{),}
                 \KeywordTok{extout}\NormalTok{(}\StringTok{"Female"}\NormalTok{,}\DecValTok{65}\NormalTok{,}\DecValTok{1}\NormalTok{),}
                 ...
                 \KeywordTok{extout}\NormalTok{(}\StringTok{"Male"}\NormalTok{,}\DecValTok{55}\NormalTok{,}\DecValTok{1}\NormalTok{),}
                 \KeywordTok{extout}\NormalTok{(}\StringTok{"Male"}\NormalTok{,}\DecValTok{65}\NormalTok{,}\DecValTok{1}\NormalTok{))}
\NormalTok{outdt2m <-}\StringTok{ }\KeywordTok{as.data.frame}\NormalTok{(outdt2m)}
\ControlFlowTok{for}\NormalTok{(i }\ControlFlowTok{in} \DecValTok{2}\OperatorTok{:}\DecValTok{9}\NormalTok{) outdt2m[,i] <-}\StringTok{ }\KeywordTok{as.numeric}\NormalTok{(outdt2m[,i])}
\NormalTok{outdt2m}\OperatorTok{$}\NormalTok{gender <-}\StringTok{ }\KeywordTok{factor}\NormalTok{(outdt2m}\OperatorTok{$}\NormalTok{gender, }\DataTypeTok{levels=}\KeywordTok{unique}\NormalTok{(outdt2m}\OperatorTok{$}\NormalTok{gender))}
\KeywordTok{summary}\NormalTok{(outdt2m)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{s2mm01_}\DecValTok{10}\NormalTok{ <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(knowledge }\OperatorTok{~}\StringTok{ }\NormalTok{., basemod0), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s2mm01_1A <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(knowledge }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodA), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s2mm01_1B <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(knowledge }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodB), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s2mm01_1C <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(knowledge }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodC), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\KeywordTok{screenreg}\NormalTok{(}\KeywordTok{list}\NormalTok{(s2mm01_}\DecValTok{10}\NormalTok{,s2mm01_1A,s2mm01_1B,s2mm01_1C), }\DataTypeTok{digits =} \DecValTok{4}\NormalTok{, }\CommentTok{#single.row = T,}
          \DataTypeTok{override.se =} \KeywordTok{list}\NormalTok{(}\KeywordTok{coeftest}\NormalTok{(s2mm01_}\DecValTok{10}\NormalTok{,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s2mm01_}\DecValTok{10}\NormalTok{))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s2mm01_1A,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s2mm01_1A))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s2mm01_1B,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s2mm01_1B))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s2mm01_1C,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s2mm01_1C))[,}\DecValTok{2}\NormalTok{]),}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{s2mm02_}\DecValTok{10}\NormalTok{ <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(ideology }\OperatorTok{~}\StringTok{ }\NormalTok{., basemod0), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s2mm02_1A <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(ideology }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodA), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s2mm02_1B <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(ideology }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodB), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s2mm02_1C <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(ideology }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodC), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\KeywordTok{screenreg}\NormalTok{(}\KeywordTok{list}\NormalTok{(s2mm02_}\DecValTok{10}\NormalTok{,s2mm02_1A,s2mm02_1B,s2mm02_1C), }\DataTypeTok{digits =} \DecValTok{4}\NormalTok{, }\CommentTok{#single.row = T,}
          \DataTypeTok{override.se =} \KeywordTok{list}\NormalTok{(}\KeywordTok{coeftest}\NormalTok{(s2mm02_}\DecValTok{10}\NormalTok{,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s2mm02_}\DecValTok{10}\NormalTok{))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s2mm02_1A,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s2mm02_1A))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s2mm02_1B,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s2mm02_1B))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s2mm02_1C,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s2mm02_1C))[,}\DecValTok{2}\NormalTok{]),}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{s2mm03_}\DecValTok{10}\NormalTok{ <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(ldpdpjft }\OperatorTok{~}\StringTok{ }\NormalTok{., basemod0), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s2mm03_1A <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(ldpdpjft }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodA), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s2mm03_1B <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(ldpdpjft }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodB), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s2mm03_1C <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(ldpdpjft }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodC), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\KeywordTok{screenreg}\NormalTok{(}\KeywordTok{list}\NormalTok{(s2mm03_}\DecValTok{10}\NormalTok{,s2mm03_1A,s2mm03_1B,s2mm03_1C), }\DataTypeTok{digits =} \DecValTok{4}\NormalTok{, }\CommentTok{#single.row = T,}
          \DataTypeTok{override.se =} \KeywordTok{list}\NormalTok{(}\KeywordTok{coeftest}\NormalTok{(s2mm03_}\DecValTok{10}\NormalTok{,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s2mm03_}\DecValTok{10}\NormalTok{))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s2mm03_1A,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s2mm03_1A))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s2mm03_1B,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s2mm03_1B))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s2mm03_1C,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s2mm03_1C))[,}\DecValTok{2}\NormalTok{]),}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{s2mm04_}\DecValTok{10}\NormalTok{ <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_KOR }\OperatorTok{~}\StringTok{ }\NormalTok{., basemod0), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s2mm04_1A <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_KOR }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodA), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s2mm04_1B <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_KOR }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodB), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s2mm04_1C <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_KOR }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodC), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\KeywordTok{screenreg}\NormalTok{(}\KeywordTok{list}\NormalTok{(s2mm04_}\DecValTok{10}\NormalTok{,s2mm04_1A,s2mm04_1B,s2mm04_1C), }\DataTypeTok{digits =} \DecValTok{4}\NormalTok{, }\CommentTok{#single.row = T,}
          \DataTypeTok{override.se =} \KeywordTok{list}\NormalTok{(}\KeywordTok{coeftest}\NormalTok{(s2mm04_}\DecValTok{10}\NormalTok{,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s2mm04_}\DecValTok{10}\NormalTok{))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s2mm04_1A,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s2mm04_1A))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s2mm04_1B,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s2mm04_1B))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s2mm04_1C,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s2mm04_1C))[,}\DecValTok{2}\NormalTok{]),}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{s2mm05_}\DecValTok{10}\NormalTok{ <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_CHN }\OperatorTok{~}\StringTok{ }\NormalTok{., basemod0), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s2mm05_1A <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_CHN }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodA), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s2mm05_1B <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_CHN }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodB), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s2mm05_1C <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_CHN }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodC), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\KeywordTok{screenreg}\NormalTok{(}\KeywordTok{list}\NormalTok{(s2mm05_}\DecValTok{10}\NormalTok{,s2mm05_1A,s2mm05_1B,s2mm05_1C), }\DataTypeTok{digits =} \DecValTok{4}\NormalTok{, }\CommentTok{#single.row = T,}
          \DataTypeTok{override.se =} \KeywordTok{list}\NormalTok{(}\KeywordTok{coeftest}\NormalTok{(s2mm05_}\DecValTok{10}\NormalTok{,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s2mm05_}\DecValTok{10}\NormalTok{))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s2mm05_1A,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s2mm05_1A))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s2mm05_1B,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s2mm05_1B))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s2mm05_1C,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s2mm05_1C))[,}\DecValTok{2}\NormalTok{]),}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{s2mm06_}\DecValTok{10}\NormalTok{ <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_USA }\OperatorTok{~}\StringTok{ }\NormalTok{., basemod0), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s2mm06_1A <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_USA }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodA), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s2mm06_1B <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_USA }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodB), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s2mm06_1C <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_USA }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodC), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\KeywordTok{screenreg}\NormalTok{(}\KeywordTok{list}\NormalTok{(s2mm06_}\DecValTok{10}\NormalTok{,s2mm06_1A,s2mm06_1B,s2mm06_1C), }\DataTypeTok{digits =} \DecValTok{4}\NormalTok{, }\CommentTok{#single.row = T,}
          \DataTypeTok{override.se =} \KeywordTok{list}\NormalTok{(}\KeywordTok{coeftest}\NormalTok{(s2mm06_}\DecValTok{10}\NormalTok{,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s2mm06_}\DecValTok{10}\NormalTok{))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s2mm06_1A,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s2mm06_1A))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s2mm06_1B,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s2mm06_1B))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s2mm06_1C,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s2mm06_1C))[,}\DecValTok{2}\NormalTok{]),}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{s2mm07_}\DecValTok{10}\NormalTok{ <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(income }\OperatorTok{~}\StringTok{ }\NormalTok{., basemod0), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s2mm07_1A <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(income }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodA), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s2mm07_1B <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(income }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodB), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s2mm07_1C <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(income }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodC), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\KeywordTok{screenreg}\NormalTok{(}\KeywordTok{list}\NormalTok{(s2mm07_}\DecValTok{10}\NormalTok{,s2mm07_1A,s2mm07_1B,s2mm07_1C), }\DataTypeTok{digits =} \DecValTok{4}\NormalTok{, }\CommentTok{#single.row = T,}
          \DataTypeTok{override.se =} \KeywordTok{list}\NormalTok{(}\KeywordTok{coeftest}\NormalTok{(s2mm07_}\DecValTok{10}\NormalTok{,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s2mm07_}\DecValTok{10}\NormalTok{))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s2mm07_1A,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s2mm07_1A))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s2mm07_1B,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s2mm07_1B))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s2mm07_1C,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s2mm07_1C))[,}\DecValTok{2}\NormalTok{]),}
...
\hypertarget{outcome-model-4}{%
\subsection{Outcome Model}\label{outcome-model-4}}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{## Living in Local ZIP since at least age 15 ##}

\NormalTok{s3mo_}\DecValTok{10}\NormalTok{ <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(foreignsuff }\OperatorTok{~}\StringTok{ }\NormalTok{., basemod0), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s3mo_1A <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(foreignsuff }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodA), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s3mo_1B <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(foreignsuff }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodB), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s3mo_1C <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(foreignsuff }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodC), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\KeywordTok{screenreg}\NormalTok{(}\KeywordTok{list}\NormalTok{(s3mo_}\DecValTok{10}\NormalTok{,s3mo_1A,s3mo_1B,s3mo_1C), }\DataTypeTok{digits =} \DecValTok{4}\NormalTok{, }\CommentTok{#single.row = T,}
          \DataTypeTok{override.se =} \KeywordTok{list}\NormalTok{(}\KeywordTok{coeftest}\NormalTok{(s3mo_}\DecValTok{10}\NormalTok{,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s3mo_}\DecValTok{10}\NormalTok{))[,}\DecValTok{2}\NormalTok{],}
...
\NormalTok{outdt3 <-}\StringTok{ }\KeywordTok{rbind}\NormalTok{(}\KeywordTok{extout}\NormalTok{(}\StringTok{"Female"}\NormalTok{,}\DecValTok{25}\NormalTok{),}
                \KeywordTok{extout}\NormalTok{(}\StringTok{"Female"}\NormalTok{,}\DecValTok{35}\NormalTok{),}
                \KeywordTok{extout}\NormalTok{(}\StringTok{"Female"}\NormalTok{,}\DecValTok{45}\NormalTok{),}
                \KeywordTok{extout}\NormalTok{(}\StringTok{"Female"}\NormalTok{,}\DecValTok{55}\NormalTok{),}
                \KeywordTok{extout}\NormalTok{(}\StringTok{"Female"}\NormalTok{,}\DecValTok{65}\NormalTok{),}
                ...
                \KeywordTok{extout}\NormalTok{(}\StringTok{"Male"}\NormalTok{,}\DecValTok{55}\NormalTok{),}
                \KeywordTok{extout}\NormalTok{(}\StringTok{"Male"}\NormalTok{,}\DecValTok{65}\NormalTok{))}
\NormalTok{outdt3 <-}\StringTok{ }\KeywordTok{as.data.frame}\NormalTok{(outdt3)}
\ControlFlowTok{for}\NormalTok{(i }\ControlFlowTok{in} \DecValTok{2}\OperatorTok{:}\DecValTok{9}\NormalTok{) outdt3[,i] <-}\StringTok{ }\KeywordTok{as.numeric}\NormalTok{(outdt3[,i])}
\NormalTok{outdt3}\OperatorTok{$}\NormalTok{gender <-}\StringTok{ }\KeywordTok{factor}\NormalTok{(outdt3}\OperatorTok{$}\NormalTok{gender, }\DataTypeTok{levels=}\KeywordTok{unique}\NormalTok{(outdt3}\OperatorTok{$}\NormalTok{gender))}
\KeywordTok{summary}\NormalTok{(outdt3)}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{# require(nnet)}
\CommentTok{# s3mo2_10 <- multinom(update(foreignsuff3x ~ ., basemod0), data=sifcct[which(sifcct$age - sifcct$lvlen<=15),])}
\CommentTok{# s3mo2_1A <- multinom(update(foreignsuff3x ~ ., basemodA), data=sifcct[which(sifcct$age - sifcct$lvlen<=15),])}
\CommentTok{# s3mo2_1B <- multinom(update(foreignsuff3x ~ ., basemodB), data=sifcct[which(sifcct$age - sifcct$lvlen<=15),])}
\CommentTok{# s3mo2_1C <- multinom(update(foreignsuff3x ~ ., basemodC), data=sifcct[which(sifcct$age - sifcct$lvlen<=15),])}

\NormalTok{sifcct.mlogit <-}\StringTok{ }\KeywordTok{dfidx}\NormalTok{(sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),],}
                       \DataTypeTok{shape =} \StringTok{"wide"}\NormalTok{, }\DataTypeTok{choice =} \StringTok{"foreignsuff3x"}\NormalTok{)}
\CommentTok{# # levels(sifcct.mlogit$idx$id2) <- c("Disagree","Neither","Agree")}
\NormalTok{s3mo2_}\DecValTok{10}\NormalTok{ <-}\StringTok{ }\KeywordTok{mlogit}\NormalTok{(outmod0.mlogit, }\DataTypeTok{data=}\NormalTok{sifcct.mlogit, }\DataTypeTok{reflevel=}\StringTok{"Disagree"}\NormalTok{)}
\NormalTok{s3mo2_1A <-}\StringTok{ }\KeywordTok{mlogit}\NormalTok{(outmodA.mlogit, }\DataTypeTok{data=}\NormalTok{sifcct.mlogit, }\DataTypeTok{reflevel=}\StringTok{"Disagree"}\NormalTok{)}
\NormalTok{s3mo2_1B <-}\StringTok{ }\KeywordTok{mlogit}\NormalTok{(outmodB.mlogit, }\DataTypeTok{data=}\NormalTok{sifcct.mlogit, }\DataTypeTok{reflevel=}\StringTok{"Disagree"}\NormalTok{)}
\NormalTok{s3mo2_1C <-}\StringTok{ }\KeywordTok{mlogit}\NormalTok{(outmodC.mlogit, }\DataTypeTok{data=}\NormalTok{sifcct.mlogit, }\DataTypeTok{reflevel=}\StringTok{"Disagree"}\NormalTok{)}
...
\NormalTok{outdt3m <-}\StringTok{ }\KeywordTok{rbind}\NormalTok{(}\KeywordTok{extout}\NormalTok{(}\StringTok{"Female"}\NormalTok{,}\DecValTok{25}\NormalTok{,}\DecValTok{1}\NormalTok{),}
                 \KeywordTok{extout}\NormalTok{(}\StringTok{"Female"}\NormalTok{,}\DecValTok{35}\NormalTok{,}\DecValTok{1}\NormalTok{),}
                 \KeywordTok{extout}\NormalTok{(}\StringTok{"Female"}\NormalTok{,}\DecValTok{45}\NormalTok{,}\DecValTok{1}\NormalTok{),}
                 \KeywordTok{extout}\NormalTok{(}\StringTok{"Female"}\NormalTok{,}\DecValTok{55}\NormalTok{,}\DecValTok{1}\NormalTok{),}
                 \KeywordTok{extout}\NormalTok{(}\StringTok{"Female"}\NormalTok{,}\DecValTok{65}\NormalTok{,}\DecValTok{1}\NormalTok{),}
                 ...
                 \KeywordTok{extout}\NormalTok{(}\StringTok{"Male"}\NormalTok{,}\DecValTok{55}\NormalTok{,}\DecValTok{1}\NormalTok{),}
                 \KeywordTok{extout}\NormalTok{(}\StringTok{"Male"}\NormalTok{,}\DecValTok{65}\NormalTok{,}\DecValTok{1}\NormalTok{))}
\NormalTok{outdt3m <-}\StringTok{ }\KeywordTok{as.data.frame}\NormalTok{(outdt3m)}
\ControlFlowTok{for}\NormalTok{(i }\ControlFlowTok{in} \DecValTok{2}\OperatorTok{:}\DecValTok{9}\NormalTok{) outdt3m[,i] <-}\StringTok{ }\KeywordTok{as.numeric}\NormalTok{(outdt3m[,i])}
\NormalTok{outdt3m}\OperatorTok{$}\NormalTok{gender <-}\StringTok{ }\KeywordTok{factor}\NormalTok{(outdt3m}\OperatorTok{$}\NormalTok{gender, }\DataTypeTok{levels=}\KeywordTok{unique}\NormalTok{(outdt3m}\OperatorTok{$}\NormalTok{gender))}
\KeywordTok{summary}\NormalTok{(outdt3m)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{s3mm01_}\DecValTok{10}\NormalTok{ <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(knowledge }\OperatorTok{~}\StringTok{ }\NormalTok{., basemod0), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s3mm01_1A <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(knowledge }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodA), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s3mm01_1B <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(knowledge }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodB), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s3mm01_1C <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(knowledge }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodC), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\KeywordTok{screenreg}\NormalTok{(}\KeywordTok{list}\NormalTok{(s3mm01_}\DecValTok{10}\NormalTok{,s3mm01_1A,s3mm01_1B,s3mm01_1C), }\DataTypeTok{digits =} \DecValTok{4}\NormalTok{, }\CommentTok{#single.row = T,}
          \DataTypeTok{override.se =} \KeywordTok{list}\NormalTok{(}\KeywordTok{coeftest}\NormalTok{(s3mm01_}\DecValTok{10}\NormalTok{,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s3mm01_}\DecValTok{10}\NormalTok{))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s3mm01_1A,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s3mm01_1A))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s3mm01_1B,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s3mm01_1B))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s3mm01_1C,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s3mm01_1C))[,}\DecValTok{2}\NormalTok{]),}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{s3mm02_}\DecValTok{10}\NormalTok{ <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(ideology }\OperatorTok{~}\StringTok{ }\NormalTok{., basemod0), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s3mm02_1A <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(ideology }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodA), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s3mm02_1B <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(ideology }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodB), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s3mm02_1C <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(ideology }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodC), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\KeywordTok{screenreg}\NormalTok{(}\KeywordTok{list}\NormalTok{(s3mm02_}\DecValTok{10}\NormalTok{,s3mm02_1A,s3mm02_1B,s3mm02_1C), }\DataTypeTok{digits =} \DecValTok{4}\NormalTok{, }\CommentTok{#single.row = T,}
          \DataTypeTok{override.se =} \KeywordTok{list}\NormalTok{(}\KeywordTok{coeftest}\NormalTok{(s3mm02_}\DecValTok{10}\NormalTok{,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s3mm02_}\DecValTok{10}\NormalTok{))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s3mm02_1A,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s3mm02_1A))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s3mm02_1B,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s3mm02_1B))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s3mm02_1C,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s3mm02_1C))[,}\DecValTok{2}\NormalTok{]),}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{s3mm03_}\DecValTok{10}\NormalTok{ <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(ldpdpjft }\OperatorTok{~}\StringTok{ }\NormalTok{., basemod0), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s3mm03_1A <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(ldpdpjft }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodA), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s3mm03_1B <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(ldpdpjft }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodB), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s3mm03_1C <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(ldpdpjft }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodC), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\KeywordTok{screenreg}\NormalTok{(}\KeywordTok{list}\NormalTok{(s3mm03_}\DecValTok{10}\NormalTok{,s3mm03_1A,s3mm03_1B,s3mm03_1C), }\DataTypeTok{digits =} \DecValTok{4}\NormalTok{, }\CommentTok{#single.row = T,}
          \DataTypeTok{override.se =} \KeywordTok{list}\NormalTok{(}\KeywordTok{coeftest}\NormalTok{(s3mm03_}\DecValTok{10}\NormalTok{,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s3mm03_}\DecValTok{10}\NormalTok{))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s3mm03_1A,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s3mm03_1A))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s3mm03_1B,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s3mm03_1B))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s3mm03_1C,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s3mm03_1C))[,}\DecValTok{2}\NormalTok{]),}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{s3mm04_}\DecValTok{10}\NormalTok{ <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_KOR }\OperatorTok{~}\StringTok{ }\NormalTok{., basemod0), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s3mm04_1A <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_KOR }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodA), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s3mm04_1B <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_KOR }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodB), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s3mm04_1C <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_KOR }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodC), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\KeywordTok{screenreg}\NormalTok{(}\KeywordTok{list}\NormalTok{(s3mm04_}\DecValTok{10}\NormalTok{,s3mm04_1A,s3mm04_1B,s3mm04_1C), }\DataTypeTok{digits =} \DecValTok{4}\NormalTok{, }\CommentTok{#single.row = T,}
          \DataTypeTok{override.se =} \KeywordTok{list}\NormalTok{(}\KeywordTok{coeftest}\NormalTok{(s3mm04_}\DecValTok{10}\NormalTok{,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s3mm04_}\DecValTok{10}\NormalTok{))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s3mm04_1A,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s3mm04_1A))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s3mm04_1B,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s3mm04_1B))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s3mm04_1C,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s3mm04_1C))[,}\DecValTok{2}\NormalTok{]),}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{s3mm05_}\DecValTok{10}\NormalTok{ <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_CHN }\OperatorTok{~}\StringTok{ }\NormalTok{., basemod0), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s3mm05_1A <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_CHN }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodA), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s3mm05_1B <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_CHN }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodB), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s3mm05_1C <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_CHN }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodC), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\KeywordTok{screenreg}\NormalTok{(}\KeywordTok{list}\NormalTok{(s3mm05_}\DecValTok{10}\NormalTok{,s3mm05_1A,s3mm05_1B,s3mm05_1C), }\DataTypeTok{digits =} \DecValTok{4}\NormalTok{, }\CommentTok{#single.row = T,}
          \DataTypeTok{override.se =} \KeywordTok{list}\NormalTok{(}\KeywordTok{coeftest}\NormalTok{(s3mm05_}\DecValTok{10}\NormalTok{,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s3mm05_}\DecValTok{10}\NormalTok{))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s3mm05_1A,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s3mm05_1A))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s3mm05_1B,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s3mm05_1B))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s3mm05_1C,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s3mm05_1C))[,}\DecValTok{2}\NormalTok{]),}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{s3mm06_}\DecValTok{10}\NormalTok{ <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_USA }\OperatorTok{~}\StringTok{ }\NormalTok{., basemod0), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s3mm06_1A <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_USA }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodA), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s3mm06_1B <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_USA }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodB), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s3mm06_1C <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_USA }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodC), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\KeywordTok{screenreg}\NormalTok{(}\KeywordTok{list}\NormalTok{(s3mm06_}\DecValTok{10}\NormalTok{,s3mm06_1A,s3mm06_1B,s3mm06_1C), }\DataTypeTok{digits =} \DecValTok{4}\NormalTok{, }\CommentTok{#single.row = T,}
          \DataTypeTok{override.se =} \KeywordTok{list}\NormalTok{(}\KeywordTok{coeftest}\NormalTok{(s3mm06_}\DecValTok{10}\NormalTok{,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s3mm06_}\DecValTok{10}\NormalTok{))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s3mm06_1A,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s3mm06_1A))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s3mm06_1B,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s3mm06_1B))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s3mm06_1C,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s3mm06_1C))[,}\DecValTok{2}\NormalTok{]),}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{s3mm07_}\DecValTok{10}\NormalTok{ <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(income }\OperatorTok{~}\StringTok{ }\NormalTok{., basemod0), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s3mm07_1A <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(income }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodA), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s3mm07_1B <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(income }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodB), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s3mm07_1C <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(income }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodC), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\KeywordTok{screenreg}\NormalTok{(}\KeywordTok{list}\NormalTok{(s3mm07_}\DecValTok{10}\NormalTok{,s3mm07_1A,s3mm07_1B,s3mm07_1C), }\DataTypeTok{digits =} \DecValTok{4}\NormalTok{, }\CommentTok{#single.row = T,}
          \DataTypeTok{override.se =} \KeywordTok{list}\NormalTok{(}\KeywordTok{coeftest}\NormalTok{(s3mm07_}\DecValTok{10}\NormalTok{,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s3mm07_}\DecValTok{10}\NormalTok{))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s3mm07_1A,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s3mm07_1A))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s3mm07_1B,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s3mm07_1B))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s3mm07_1C,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s3mm07_1C))[,}\DecValTok{2}\NormalTok{]),}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{sifcct <-}\StringTok{ }\KeywordTok{readRDS}\NormalTok{(datadir4)}
\NormalTok{sifcct}\OperatorTok{$}\NormalTok{agex <-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{age}\OperatorTok{/}\DecValTok{10} \OperatorTok{-}\StringTok{ }\FloatTok{4.5}
\NormalTok{sifcct}\OperatorTok{$}\NormalTok{ldpdpjft <-}\StringTok{ }\NormalTok{original}\OperatorTok{$}\NormalTok{ldpdpjft[}\KeywordTok{match}\NormalTok{(}\KeywordTok{paste}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{id,sifcct}\OperatorTok{$}\NormalTok{wave),}\KeywordTok{paste}\NormalTok{(original}\OperatorTok{$}\NormalTok{id,original}\OperatorTok{$}\NormalTok{wave))]}
\KeywordTok{summary}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{ldpdpjft)}
\end{Highlighting}
...
\hypertarget{outcome-model-5}{%
\subsection{Outcome Model}\label{outcome-model-5}}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{## Living in Local ZIP since at least age 15 ##}

\NormalTok{s4mo_}\DecValTok{10}\NormalTok{ <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(foreignsuff }\OperatorTok{~}\StringTok{ }\NormalTok{., basemod0), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s4mo_1A <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(foreignsuff }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodA), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s4mo_1B <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(foreignsuff }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodB), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s4mo_1C <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(foreignsuff }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodC), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\KeywordTok{screenreg}\NormalTok{(}\KeywordTok{list}\NormalTok{(s4mo_}\DecValTok{10}\NormalTok{,s4mo_1A,s4mo_1B,s4mo_1C), }\DataTypeTok{digits =} \DecValTok{4}\NormalTok{, }\CommentTok{#single.row = T,}
          \DataTypeTok{override.se =} \KeywordTok{list}\NormalTok{(}\KeywordTok{coeftest}\NormalTok{(s4mo_}\DecValTok{10}\NormalTok{,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s4mo_}\DecValTok{10}\NormalTok{))[,}\DecValTok{2}\NormalTok{],}
...
\NormalTok{outdt4 <-}\StringTok{ }\KeywordTok{rbind}\NormalTok{(}\KeywordTok{extout}\NormalTok{(}\StringTok{"Female"}\NormalTok{,}\DecValTok{25}\NormalTok{),}
                \KeywordTok{extout}\NormalTok{(}\StringTok{"Female"}\NormalTok{,}\DecValTok{35}\NormalTok{),}
                \KeywordTok{extout}\NormalTok{(}\StringTok{"Female"}\NormalTok{,}\DecValTok{45}\NormalTok{),}
                \KeywordTok{extout}\NormalTok{(}\StringTok{"Female"}\NormalTok{,}\DecValTok{55}\NormalTok{),}
                \KeywordTok{extout}\NormalTok{(}\StringTok{"Female"}\NormalTok{,}\DecValTok{65}\NormalTok{),}
                ...
                \KeywordTok{extout}\NormalTok{(}\StringTok{"Male"}\NormalTok{,}\DecValTok{55}\NormalTok{),}
                \KeywordTok{extout}\NormalTok{(}\StringTok{"Male"}\NormalTok{,}\DecValTok{65}\NormalTok{))}
\NormalTok{outdt4 <-}\StringTok{ }\KeywordTok{as.data.frame}\NormalTok{(outdt4)}
\ControlFlowTok{for}\NormalTok{(i }\ControlFlowTok{in} \DecValTok{2}\OperatorTok{:}\DecValTok{9}\NormalTok{) outdt4[,i] <-}\StringTok{ }\KeywordTok{as.numeric}\NormalTok{(outdt4[,i])}
\NormalTok{outdt4}\OperatorTok{$}\NormalTok{gender <-}\StringTok{ }\KeywordTok{factor}\NormalTok{(outdt4}\OperatorTok{$}\NormalTok{gender, }\DataTypeTok{levels=}\KeywordTok{unique}\NormalTok{(outdt4}\OperatorTok{$}\NormalTok{gender))}
\KeywordTok{summary}\NormalTok{(outdt4)}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{# require(nnet)}
\CommentTok{# s4mo2_10 <- multinom(update(foreignsuff3x ~ ., basemod0), data=sifcct[which(sifcct$age - sifcct$lvlen<=15),])}
\CommentTok{# s4mo2_1A <- multinom(update(foreignsuff3x ~ ., basemodA), data=sifcct[which(sifcct$age - sifcct$lvlen<=15),])}
\CommentTok{# s4mo2_1B <- multinom(update(foreignsuff3x ~ ., basemodB), data=sifcct[which(sifcct$age - sifcct$lvlen<=15),])}
\CommentTok{# s4mo2_1C <- multinom(update(foreignsuff3x ~ ., basemodC), data=sifcct[which(sifcct$age - sifcct$lvlen<=15),])}

\NormalTok{sifcct.mlogit <-}\StringTok{ }\KeywordTok{dfidx}\NormalTok{(sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),],}
                       \DataTypeTok{shape =} \StringTok{"wide"}\NormalTok{, }\DataTypeTok{choice =} \StringTok{"foreignsuff3x"}\NormalTok{)}
\CommentTok{# # levels(sifcct.mlogit$idx$id2) <- c("Disagree","Neither","Agree")}
\NormalTok{s4mo2_}\DecValTok{10}\NormalTok{ <-}\StringTok{ }\KeywordTok{mlogit}\NormalTok{(outmod0.mlogit, }\DataTypeTok{data=}\NormalTok{sifcct.mlogit, }\DataTypeTok{reflevel=}\StringTok{"Disagree"}\NormalTok{)}
\NormalTok{s4mo2_1A <-}\StringTok{ }\KeywordTok{mlogit}\NormalTok{(outmodA.mlogit, }\DataTypeTok{data=}\NormalTok{sifcct.mlogit, }\DataTypeTok{reflevel=}\StringTok{"Disagree"}\NormalTok{)}
\NormalTok{s4mo2_1B <-}\StringTok{ }\KeywordTok{mlogit}\NormalTok{(outmodB.mlogit, }\DataTypeTok{data=}\NormalTok{sifcct.mlogit, }\DataTypeTok{reflevel=}\StringTok{"Disagree"}\NormalTok{)}
\NormalTok{s4mo2_1C <-}\StringTok{ }\KeywordTok{mlogit}\NormalTok{(outmodC.mlogit, }\DataTypeTok{data=}\NormalTok{sifcct.mlogit, }\DataTypeTok{reflevel=}\StringTok{"Disagree"}\NormalTok{)}
...
\NormalTok{outdt4m <-}\StringTok{ }\KeywordTok{rbind}\NormalTok{(}\KeywordTok{extout}\NormalTok{(}\StringTok{"Female"}\NormalTok{,}\DecValTok{25}\NormalTok{,}\DecValTok{1}\NormalTok{),}
                 \KeywordTok{extout}\NormalTok{(}\StringTok{"Female"}\NormalTok{,}\DecValTok{35}\NormalTok{,}\DecValTok{1}\NormalTok{),}
                 \KeywordTok{extout}\NormalTok{(}\StringTok{"Female"}\NormalTok{,}\DecValTok{45}\NormalTok{,}\DecValTok{1}\NormalTok{),}
                 \KeywordTok{extout}\NormalTok{(}\StringTok{"Female"}\NormalTok{,}\DecValTok{55}\NormalTok{,}\DecValTok{1}\NormalTok{),}
                 \KeywordTok{extout}\NormalTok{(}\StringTok{"Female"}\NormalTok{,}\DecValTok{65}\NormalTok{,}\DecValTok{1}\NormalTok{),}
                 ...
                 \KeywordTok{extout}\NormalTok{(}\StringTok{"Male"}\NormalTok{,}\DecValTok{55}\NormalTok{,}\DecValTok{1}\NormalTok{),}
                 \KeywordTok{extout}\NormalTok{(}\StringTok{"Male"}\NormalTok{,}\DecValTok{65}\NormalTok{,}\DecValTok{1}\NormalTok{))}
\NormalTok{outdt4m <-}\StringTok{ }\KeywordTok{as.data.frame}\NormalTok{(outdt4m)}
\ControlFlowTok{for}\NormalTok{(i }\ControlFlowTok{in} \DecValTok{2}\OperatorTok{:}\DecValTok{9}\NormalTok{) outdt4m[,i] <-}\StringTok{ }\KeywordTok{as.numeric}\NormalTok{(outdt4m[,i])}
\NormalTok{outdt4m}\OperatorTok{$}\NormalTok{gender <-}\StringTok{ }\KeywordTok{factor}\NormalTok{(outdt4m}\OperatorTok{$}\NormalTok{gender, }\DataTypeTok{levels=}\KeywordTok{unique}\NormalTok{(outdt4m}\OperatorTok{$}\NormalTok{gender))}
\KeywordTok{summary}\NormalTok{(outdt4m)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{s4mm01_}\DecValTok{10}\NormalTok{ <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(knowledge }\OperatorTok{~}\StringTok{ }\NormalTok{., basemod0), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s4mm01_1A <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(knowledge }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodA), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s4mm01_1B <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(knowledge }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodB), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s4mm01_1C <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(knowledge }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodC), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\KeywordTok{screenreg}\NormalTok{(}\KeywordTok{list}\NormalTok{(s4mm01_}\DecValTok{10}\NormalTok{,s4mm01_1A,s4mm01_1B,s4mm01_1C), }\DataTypeTok{digits =} \DecValTok{4}\NormalTok{, }\CommentTok{#single.row = T,}
          \DataTypeTok{override.se =} \KeywordTok{list}\NormalTok{(}\KeywordTok{coeftest}\NormalTok{(s4mm01_}\DecValTok{10}\NormalTok{,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s4mm01_}\DecValTok{10}\NormalTok{))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s4mm01_1A,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s4mm01_1A))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s4mm01_1B,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s4mm01_1B))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s4mm01_1C,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s4mm01_1C))[,}\DecValTok{2}\NormalTok{]),}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{s4mm02_}\DecValTok{10}\NormalTok{ <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(ideology }\OperatorTok{~}\StringTok{ }\NormalTok{., basemod0), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s4mm02_1A <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(ideology }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodA), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s4mm02_1B <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(ideology }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodB), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s4mm02_1C <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(ideology }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodC), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\KeywordTok{screenreg}\NormalTok{(}\KeywordTok{list}\NormalTok{(s4mm02_}\DecValTok{10}\NormalTok{,s4mm02_1A,s4mm02_1B,s4mm02_1C), }\DataTypeTok{digits =} \DecValTok{4}\NormalTok{, }\CommentTok{#single.row = T,}
          \DataTypeTok{override.se =} \KeywordTok{list}\NormalTok{(}\KeywordTok{coeftest}\NormalTok{(s4mm02_}\DecValTok{10}\NormalTok{,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s4mm02_}\DecValTok{10}\NormalTok{))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s4mm02_1A,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s4mm02_1A))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s4mm02_1B,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s4mm02_1B))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s4mm02_1C,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s4mm02_1C))[,}\DecValTok{2}\NormalTok{]),}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{s4mm03_}\DecValTok{10}\NormalTok{ <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(ldpdpjft }\OperatorTok{~}\StringTok{ }\NormalTok{., basemod0), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s4mm03_1A <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(ldpdpjft }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodA), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s4mm03_1B <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(ldpdpjft }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodB), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s4mm03_1C <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(ldpdpjft }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodC), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\KeywordTok{screenreg}\NormalTok{(}\KeywordTok{list}\NormalTok{(s4mm03_}\DecValTok{10}\NormalTok{,s4mm03_1A,s4mm03_1B,s4mm03_1C), }\DataTypeTok{digits =} \DecValTok{4}\NormalTok{, }\CommentTok{#single.row = T,}
          \DataTypeTok{override.se =} \KeywordTok{list}\NormalTok{(}\KeywordTok{coeftest}\NormalTok{(s4mm03_}\DecValTok{10}\NormalTok{,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s4mm03_}\DecValTok{10}\NormalTok{))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s4mm03_1A,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s4mm03_1A))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s4mm03_1B,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s4mm03_1B))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s4mm03_1C,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s4mm03_1C))[,}\DecValTok{2}\NormalTok{]),}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{s4mm04_}\DecValTok{10}\NormalTok{ <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_KOR }\OperatorTok{~}\StringTok{ }\NormalTok{., basemod0), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s4mm04_1A <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_KOR }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodA), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s4mm04_1B <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_KOR }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodB), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s4mm04_1C <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_KOR }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodC), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\KeywordTok{screenreg}\NormalTok{(}\KeywordTok{list}\NormalTok{(s4mm04_}\DecValTok{10}\NormalTok{,s4mm04_1A,s4mm04_1B,s4mm04_1C), }\DataTypeTok{digits =} \DecValTok{4}\NormalTok{, }\CommentTok{#single.row = T,}
          \DataTypeTok{override.se =} \KeywordTok{list}\NormalTok{(}\KeywordTok{coeftest}\NormalTok{(s4mm04_}\DecValTok{10}\NormalTok{,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s4mm04_}\DecValTok{10}\NormalTok{))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s4mm04_1A,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s4mm04_1A))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s4mm04_1B,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s4mm04_1B))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s4mm04_1C,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s4mm04_1C))[,}\DecValTok{2}\NormalTok{]),}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{s4mm05_}\DecValTok{10}\NormalTok{ <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_CHN }\OperatorTok{~}\StringTok{ }\NormalTok{., basemod0), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s4mm05_1A <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_CHN }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodA), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s4mm05_1B <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_CHN }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodB), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s4mm05_1C <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_CHN }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodC), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\KeywordTok{screenreg}\NormalTok{(}\KeywordTok{list}\NormalTok{(s4mm05_}\DecValTok{10}\NormalTok{,s4mm05_1A,s4mm05_1B,s4mm05_1C), }\DataTypeTok{digits =} \DecValTok{4}\NormalTok{, }\CommentTok{#single.row = T,}
          \DataTypeTok{override.se =} \KeywordTok{list}\NormalTok{(}\KeywordTok{coeftest}\NormalTok{(s4mm05_}\DecValTok{10}\NormalTok{,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s4mm05_}\DecValTok{10}\NormalTok{))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s4mm05_1A,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s4mm05_1A))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s4mm05_1B,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s4mm05_1B))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s4mm05_1C,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s4mm05_1C))[,}\DecValTok{2}\NormalTok{]),}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{s4mm06_}\DecValTok{10}\NormalTok{ <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_USA }\OperatorTok{~}\StringTok{ }\NormalTok{., basemod0), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s4mm06_1A <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_USA }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodA), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s4mm06_1B <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_USA }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodB), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s4mm06_1C <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_USA }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodC), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\KeywordTok{screenreg}\NormalTok{(}\KeywordTok{list}\NormalTok{(s4mm06_}\DecValTok{10}\NormalTok{,s4mm06_1A,s4mm06_1B,s4mm06_1C), }\DataTypeTok{digits =} \DecValTok{4}\NormalTok{, }\CommentTok{#single.row = T,}
          \DataTypeTok{override.se =} \KeywordTok{list}\NormalTok{(}\KeywordTok{coeftest}\NormalTok{(s4mm06_}\DecValTok{10}\NormalTok{,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s4mm06_}\DecValTok{10}\NormalTok{))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s4mm06_1A,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s4mm06_1A))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s4mm06_1B,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s4mm06_1B))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s4mm06_1C,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s4mm06_1C))[,}\DecValTok{2}\NormalTok{]),}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{s4mm07_}\DecValTok{10}\NormalTok{ <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(income }\OperatorTok{~}\StringTok{ }\NormalTok{., basemod0), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s4mm07_1A <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(income }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodA), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s4mm07_1B <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(income }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodB), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s4mm07_1C <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(income }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodC), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\KeywordTok{screenreg}\NormalTok{(}\KeywordTok{list}\NormalTok{(s4mm07_}\DecValTok{10}\NormalTok{,s4mm07_1A,s4mm07_1B,s4mm07_1C), }\DataTypeTok{digits =} \DecValTok{4}\NormalTok{, }\CommentTok{#single.row = T,}
          \DataTypeTok{override.se =} \KeywordTok{list}\NormalTok{(}\KeywordTok{coeftest}\NormalTok{(s4mm07_}\DecValTok{10}\NormalTok{,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s4mm07_}\DecValTok{10}\NormalTok{))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s4mm07_1A,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s4mm07_1A))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s4mm07_1B,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s4mm07_1B))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s4mm07_1C,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s4mm07_1C))[,}\DecValTok{2}\NormalTok{]),}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{sifcct <-}\StringTok{ }\KeywordTok{readRDS}\NormalTok{(datadir5)}
\NormalTok{sifcct}\OperatorTok{$}\NormalTok{agex <-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{age}\OperatorTok{/}\DecValTok{10} \OperatorTok{-}\StringTok{ }\FloatTok{4.5}
\NormalTok{sifcct}\OperatorTok{$}\NormalTok{ldpdpjft <-}\StringTok{ }\NormalTok{original}\OperatorTok{$}\NormalTok{ldpdpjft[}\KeywordTok{match}\NormalTok{(}\KeywordTok{paste}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{id,sifcct}\OperatorTok{$}\NormalTok{wave),}\KeywordTok{paste}\NormalTok{(original}\OperatorTok{$}\NormalTok{id,original}\OperatorTok{$}\NormalTok{wave))]}
\KeywordTok{summary}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{ldpdpjft)}
\end{Highlighting}
...
\hypertarget{outcome-model-6}{%
\subsection{Outcome Model}\label{outcome-model-6}}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{## Living in Local ZIP since at least age 15 ##}

\NormalTok{s5mo_}\DecValTok{10}\NormalTok{ <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(foreignsuff }\OperatorTok{~}\StringTok{ }\NormalTok{., basemod0), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s5mo_1A <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(foreignsuff }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodA), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s5mo_1B <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(foreignsuff }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodB), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s5mo_1C <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(foreignsuff }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodC), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\KeywordTok{screenreg}\NormalTok{(}\KeywordTok{list}\NormalTok{(s5mo_}\DecValTok{10}\NormalTok{,s5mo_1A,s5mo_1B,s5mo_1C), }\DataTypeTok{digits =} \DecValTok{4}\NormalTok{, }\CommentTok{#single.row = T,}
          \DataTypeTok{override.se =} \KeywordTok{list}\NormalTok{(}\KeywordTok{coeftest}\NormalTok{(s5mo_}\DecValTok{10}\NormalTok{,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s5mo_}\DecValTok{10}\NormalTok{))[,}\DecValTok{2}\NormalTok{],}
...
\NormalTok{outdt5 <-}\StringTok{ }\KeywordTok{rbind}\NormalTok{(}\KeywordTok{extout}\NormalTok{(}\StringTok{"Female"}\NormalTok{,}\DecValTok{25}\NormalTok{),}
                \KeywordTok{extout}\NormalTok{(}\StringTok{"Female"}\NormalTok{,}\DecValTok{35}\NormalTok{),}
                \KeywordTok{extout}\NormalTok{(}\StringTok{"Female"}\NormalTok{,}\DecValTok{45}\NormalTok{),}
                \KeywordTok{extout}\NormalTok{(}\StringTok{"Female"}\NormalTok{,}\DecValTok{55}\NormalTok{),}
                \KeywordTok{extout}\NormalTok{(}\StringTok{"Female"}\NormalTok{,}\DecValTok{65}\NormalTok{),}
                ...
                \KeywordTok{extout}\NormalTok{(}\StringTok{"Male"}\NormalTok{,}\DecValTok{55}\NormalTok{),}
                \KeywordTok{extout}\NormalTok{(}\StringTok{"Male"}\NormalTok{,}\DecValTok{65}\NormalTok{))}
\NormalTok{outdt5 <-}\StringTok{ }\KeywordTok{as.data.frame}\NormalTok{(outdt5)}
\ControlFlowTok{for}\NormalTok{(i }\ControlFlowTok{in} \DecValTok{2}\OperatorTok{:}\DecValTok{9}\NormalTok{) outdt5[,i] <-}\StringTok{ }\KeywordTok{as.numeric}\NormalTok{(outdt5[,i])}
\NormalTok{outdt5}\OperatorTok{$}\NormalTok{gender <-}\StringTok{ }\KeywordTok{factor}\NormalTok{(outdt5}\OperatorTok{$}\NormalTok{gender, }\DataTypeTok{levels=}\KeywordTok{unique}\NormalTok{(outdt5}\OperatorTok{$}\NormalTok{gender))}
\KeywordTok{summary}\NormalTok{(outdt5)}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{# require(nnet)}
\CommentTok{# s5mo2_10 <- multinom(update(foreignsuff3x ~ ., basemod0), data=sifcct[which(sifcct$age - sifcct$lvlen<=15),])}
\CommentTok{# s5mo2_1A <- multinom(update(foreignsuff3x ~ ., basemodA), data=sifcct[which(sifcct$age - sifcct$lvlen<=15),])}
\CommentTok{# s5mo2_1B <- multinom(update(foreignsuff3x ~ ., basemodB), data=sifcct[which(sifcct$age - sifcct$lvlen<=15),])}
\CommentTok{# s5mo2_1C <- multinom(update(foreignsuff3x ~ ., basemodC), data=sifcct[which(sifcct$age - sifcct$lvlen<=15),])}

\NormalTok{sifcct.mlogit <-}\StringTok{ }\KeywordTok{dfidx}\NormalTok{(sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),],}
                       \DataTypeTok{shape =} \StringTok{"wide"}\NormalTok{, }\DataTypeTok{choice =} \StringTok{"foreignsuff3x"}\NormalTok{)}
\CommentTok{# # levels(sifcct.mlogit$idx$id2) <- c("Disagree","Neither","Agree")}
\NormalTok{s5mo2_}\DecValTok{10}\NormalTok{ <-}\StringTok{ }\KeywordTok{mlogit}\NormalTok{(outmod0.mlogit, }\DataTypeTok{data=}\NormalTok{sifcct.mlogit, }\DataTypeTok{reflevel=}\StringTok{"Disagree"}\NormalTok{)}
\NormalTok{s5mo2_1A <-}\StringTok{ }\KeywordTok{mlogit}\NormalTok{(outmodA.mlogit, }\DataTypeTok{data=}\NormalTok{sifcct.mlogit, }\DataTypeTok{reflevel=}\StringTok{"Disagree"}\NormalTok{)}
\NormalTok{s5mo2_1B <-}\StringTok{ }\KeywordTok{mlogit}\NormalTok{(outmodB.mlogit, }\DataTypeTok{data=}\NormalTok{sifcct.mlogit, }\DataTypeTok{reflevel=}\StringTok{"Disagree"}\NormalTok{)}
\NormalTok{s5mo2_1C <-}\StringTok{ }\KeywordTok{mlogit}\NormalTok{(outmodC.mlogit, }\DataTypeTok{data=}\NormalTok{sifcct.mlogit, }\DataTypeTok{reflevel=}\StringTok{"Disagree"}\NormalTok{)}
...
\NormalTok{outdt5m <-}\StringTok{ }\KeywordTok{rbind}\NormalTok{(}\KeywordTok{extout}\NormalTok{(}\StringTok{"Female"}\NormalTok{,}\DecValTok{25}\NormalTok{,}\DecValTok{1}\NormalTok{),}
                 \KeywordTok{extout}\NormalTok{(}\StringTok{"Female"}\NormalTok{,}\DecValTok{35}\NormalTok{,}\DecValTok{1}\NormalTok{),}
                 \KeywordTok{extout}\NormalTok{(}\StringTok{"Female"}\NormalTok{,}\DecValTok{45}\NormalTok{,}\DecValTok{1}\NormalTok{),}
                 \KeywordTok{extout}\NormalTok{(}\StringTok{"Female"}\NormalTok{,}\DecValTok{55}\NormalTok{,}\DecValTok{1}\NormalTok{),}
                 \KeywordTok{extout}\NormalTok{(}\StringTok{"Female"}\NormalTok{,}\DecValTok{65}\NormalTok{,}\DecValTok{1}\NormalTok{),}
                 ...
                 \KeywordTok{extout}\NormalTok{(}\StringTok{"Male"}\NormalTok{,}\DecValTok{55}\NormalTok{,}\DecValTok{1}\NormalTok{),}
                 \KeywordTok{extout}\NormalTok{(}\StringTok{"Male"}\NormalTok{,}\DecValTok{65}\NormalTok{,}\DecValTok{1}\NormalTok{))}
\NormalTok{outdt5m <-}\StringTok{ }\KeywordTok{as.data.frame}\NormalTok{(outdt5m)}
\ControlFlowTok{for}\NormalTok{(i }\ControlFlowTok{in} \DecValTok{2}\OperatorTok{:}\DecValTok{9}\NormalTok{) outdt5m[,i] <-}\StringTok{ }\KeywordTok{as.numeric}\NormalTok{(outdt5m[,i])}
\NormalTok{outdt5m}\OperatorTok{$}\NormalTok{gender <-}\StringTok{ }\KeywordTok{factor}\NormalTok{(outdt5m}\OperatorTok{$}\NormalTok{gender, }\DataTypeTok{levels=}\KeywordTok{unique}\NormalTok{(outdt5m}\OperatorTok{$}\NormalTok{gender))}
\KeywordTok{summary}\NormalTok{(outdt5m)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{s5mm01_}\DecValTok{10}\NormalTok{ <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(knowledge }\OperatorTok{~}\StringTok{ }\NormalTok{., basemod0), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s5mm01_1A <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(knowledge }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodA), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s5mm01_1B <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(knowledge }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodB), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s5mm01_1C <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(knowledge }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodC), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\KeywordTok{screenreg}\NormalTok{(}\KeywordTok{list}\NormalTok{(s5mm01_}\DecValTok{10}\NormalTok{,s5mm01_1A,s5mm01_1B,s5mm01_1C), }\DataTypeTok{digits =} \DecValTok{4}\NormalTok{, }\CommentTok{#single.row = T,}
          \DataTypeTok{override.se =} \KeywordTok{list}\NormalTok{(}\KeywordTok{coeftest}\NormalTok{(s5mm01_}\DecValTok{10}\NormalTok{,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s5mm01_}\DecValTok{10}\NormalTok{))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s5mm01_1A,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s5mm01_1A))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s5mm01_1B,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s5mm01_1B))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s5mm01_1C,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s5mm01_1C))[,}\DecValTok{2}\NormalTok{]),}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{s5mm02_}\DecValTok{10}\NormalTok{ <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(ideology }\OperatorTok{~}\StringTok{ }\NormalTok{., basemod0), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s5mm02_1A <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(ideology }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodA), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s5mm02_1B <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(ideology }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodB), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s5mm02_1C <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(ideology }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodC), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\KeywordTok{screenreg}\NormalTok{(}\KeywordTok{list}\NormalTok{(s5mm02_}\DecValTok{10}\NormalTok{,s5mm02_1A,s5mm02_1B,s5mm02_1C), }\DataTypeTok{digits =} \DecValTok{4}\NormalTok{, }\CommentTok{#single.row = T,}
          \DataTypeTok{override.se =} \KeywordTok{list}\NormalTok{(}\KeywordTok{coeftest}\NormalTok{(s5mm02_}\DecValTok{10}\NormalTok{,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s5mm02_}\DecValTok{10}\NormalTok{))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s5mm02_1A,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s5mm02_1A))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s5mm02_1B,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s5mm02_1B))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s5mm02_1C,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s5mm02_1C))[,}\DecValTok{2}\NormalTok{]),}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{s5mm03_}\DecValTok{10}\NormalTok{ <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(ldpdpjft }\OperatorTok{~}\StringTok{ }\NormalTok{., basemod0), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s5mm03_1A <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(ldpdpjft }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodA), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s5mm03_1B <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(ldpdpjft }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodB), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s5mm03_1C <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(ldpdpjft }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodC), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\KeywordTok{screenreg}\NormalTok{(}\KeywordTok{list}\NormalTok{(s5mm03_}\DecValTok{10}\NormalTok{,s5mm03_1A,s5mm03_1B,s5mm03_1C), }\DataTypeTok{digits =} \DecValTok{4}\NormalTok{, }\CommentTok{#single.row = T,}
          \DataTypeTok{override.se =} \KeywordTok{list}\NormalTok{(}\KeywordTok{coeftest}\NormalTok{(s5mm03_}\DecValTok{10}\NormalTok{,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s5mm03_}\DecValTok{10}\NormalTok{))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s5mm03_1A,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s5mm03_1A))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s5mm03_1B,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s5mm03_1B))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s5mm03_1C,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s5mm03_1C))[,}\DecValTok{2}\NormalTok{]),}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{s5mm04_}\DecValTok{10}\NormalTok{ <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_KOR }\OperatorTok{~}\StringTok{ }\NormalTok{., basemod0), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s5mm04_1A <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_KOR }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodA), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s5mm04_1B <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_KOR }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodB), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s5mm04_1C <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_KOR }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodC), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\KeywordTok{screenreg}\NormalTok{(}\KeywordTok{list}\NormalTok{(s5mm04_}\DecValTok{10}\NormalTok{,s5mm04_1A,s5mm04_1B,s5mm04_1C), }\DataTypeTok{digits =} \DecValTok{4}\NormalTok{, }\CommentTok{#single.row = T,}
          \DataTypeTok{override.se =} \KeywordTok{list}\NormalTok{(}\KeywordTok{coeftest}\NormalTok{(s5mm04_}\DecValTok{10}\NormalTok{,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s5mm04_}\DecValTok{10}\NormalTok{))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s5mm04_1A,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s5mm04_1A))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s5mm04_1B,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s5mm04_1B))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s5mm04_1C,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s5mm04_1C))[,}\DecValTok{2}\NormalTok{]),}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{s5mm05_}\DecValTok{10}\NormalTok{ <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_CHN }\OperatorTok{~}\StringTok{ }\NormalTok{., basemod0), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s5mm05_1A <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_CHN }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodA), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s5mm05_1B <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_CHN }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodB), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s5mm05_1C <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_CHN }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodC), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\KeywordTok{screenreg}\NormalTok{(}\KeywordTok{list}\NormalTok{(s5mm05_}\DecValTok{10}\NormalTok{,s5mm05_1A,s5mm05_1B,s5mm05_1C), }\DataTypeTok{digits =} \DecValTok{4}\NormalTok{, }\CommentTok{#single.row = T,}
          \DataTypeTok{override.se =} \KeywordTok{list}\NormalTok{(}\KeywordTok{coeftest}\NormalTok{(s5mm05_}\DecValTok{10}\NormalTok{,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s5mm05_}\DecValTok{10}\NormalTok{))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s5mm05_1A,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s5mm05_1A))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s5mm05_1B,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s5mm05_1B))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s5mm05_1C,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s5mm05_1C))[,}\DecValTok{2}\NormalTok{]),}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{s5mm06_}\DecValTok{10}\NormalTok{ <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_USA }\OperatorTok{~}\StringTok{ }\NormalTok{., basemod0), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s5mm06_1A <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_USA }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodA), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s5mm06_1B <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_USA }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodB), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s5mm06_1C <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(familiarityFT_USA }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodC), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\KeywordTok{screenreg}\NormalTok{(}\KeywordTok{list}\NormalTok{(s5mm06_}\DecValTok{10}\NormalTok{,s5mm06_1A,s5mm06_1B,s5mm06_1C), }\DataTypeTok{digits =} \DecValTok{4}\NormalTok{, }\CommentTok{#single.row = T,}
          \DataTypeTok{override.se =} \KeywordTok{list}\NormalTok{(}\KeywordTok{coeftest}\NormalTok{(s5mm06_}\DecValTok{10}\NormalTok{,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s5mm06_}\DecValTok{10}\NormalTok{))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s5mm06_1A,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s5mm06_1A))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s5mm06_1B,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s5mm06_1B))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s5mm06_1C,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s5mm06_1C))[,}\DecValTok{2}\NormalTok{]),}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{s5mm07_}\DecValTok{10}\NormalTok{ <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(income }\OperatorTok{~}\StringTok{ }\NormalTok{., basemod0), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s5mm07_1A <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(income }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodA), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s5mm07_1B <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(income }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodB), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\NormalTok{s5mm07_1C <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{update}\NormalTok{(income }\OperatorTok{~}\StringTok{ }\NormalTok{., basemodC), }\DataTypeTok{data=}\NormalTok{sifcct[}\KeywordTok{which}\NormalTok{(sifcct}\OperatorTok{$}\NormalTok{age }\OperatorTok{-}\StringTok{ }\NormalTok{sifcct}\OperatorTok{$}\NormalTok{lvlen}\OperatorTok{<=}\DecValTok{15}\NormalTok{),])}
\KeywordTok{screenreg}\NormalTok{(}\KeywordTok{list}\NormalTok{(s5mm07_}\DecValTok{10}\NormalTok{,s5mm07_1A,s5mm07_1B,s5mm07_1C), }\DataTypeTok{digits =} \DecValTok{4}\NormalTok{, }\CommentTok{#single.row = T,}
          \DataTypeTok{override.se =} \KeywordTok{list}\NormalTok{(}\KeywordTok{coeftest}\NormalTok{(s5mm07_}\DecValTok{10}\NormalTok{,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s5mm07_}\DecValTok{10}\NormalTok{))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s5mm07_1A,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s5mm07_1A))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s5mm07_1B,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s5mm07_1B))[,}\DecValTok{2}\NormalTok{],}
                             \KeywordTok{coeftest}\NormalTok{(s5mm07_1C,}\DataTypeTok{vcov.=}\KeywordTok{vcovHC}\NormalTok{(s5mm07_1C))[,}\DecValTok{2}\NormalTok{]),}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{outdt0}\OperatorTok{$}\NormalTok{data <-}\StringTok{ "Unmatched"}
\NormalTok{outdt1}\OperatorTok{$}\NormalTok{data <-}\StringTok{ "Matched without }\CharTok{\textbackslash{}n}\StringTok{Distance Adj."}
\NormalTok{outdt2}\OperatorTok{$}\NormalTok{data <-}\StringTok{ "Matched with }\CharTok{\textbackslash{}n}\StringTok{Lambda = 50km"}
\NormalTok{outdt3}\OperatorTok{$}\NormalTok{data <-}\StringTok{ "Matched with }\CharTok{\textbackslash{}n}\StringTok{Lambda = 100km"}
\NormalTok{outdt4}\OperatorTok{$}\NormalTok{data <-}\StringTok{ "Matched with }\CharTok{\textbackslash{}n}\StringTok{Lambda = 200km"}
\NormalTok{outdt5}\OperatorTok{$}\NormalTok{data <-}\StringTok{ "Matched with }\CharTok{\textbackslash{}n}\StringTok{Lambda = 350km"}

\NormalTok{visdt <-}\StringTok{ }\KeywordTok{rbind}\NormalTok{(outdt0,outdt1,outdt2,outdt3,outdt4,outdt5)}

\NormalTok{visdt}\OperatorTok{$}\NormalTok{data <-}\StringTok{ }\KeywordTok{factor}\NormalTok{(visdt}\OperatorTok{$}\NormalTok{data, }\DataTypeTok{levels =} \KeywordTok{c}\NormalTok{(}\StringTok{"Unmatched"}\NormalTok{,}
                                            \StringTok{"Matched without }\CharTok{\textbackslash{}n}\StringTok{Distance Adj."}\NormalTok{,}
                                            \StringTok{"Matched with }\CharTok{\textbackslash{}n}\StringTok{Lambda = 350km"}\NormalTok{,}
                                            \StringTok{"Matched with }\CharTok{\textbackslash{}n}\StringTok{Lambda = 200km"}\NormalTok{,}
                                            \StringTok{"Matched with }\CharTok{\textbackslash{}n}\StringTok{Lambda = 100km"}\NormalTok{,}
                                            \StringTok{"Matched with }\CharTok{\textbackslash{}n}\StringTok{Lambda = 50km"}\NormalTok{))}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{saveRDS}\NormalTok{(visdt, }\KeywordTok{paste0}\NormalTok{(projdir, }\StringTok{"/out/visdt.rds"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{outdt0m}\OperatorTok{$}\NormalTok{data <-}\StringTok{ "Unmatched"}
\NormalTok{outdt1m}\OperatorTok{$}\NormalTok{data <-}\StringTok{ "Matched without }\CharTok{\textbackslash{}n}\StringTok{Distance Adj."}
\NormalTok{outdt2m}\OperatorTok{$}\NormalTok{data <-}\StringTok{ "Matched with }\CharTok{\textbackslash{}n}\StringTok{Lambda = 50km"}
\NormalTok{outdt3m}\OperatorTok{$}\NormalTok{data <-}\StringTok{ "Matched with }\CharTok{\textbackslash{}n}\StringTok{Lambda = 100km"}
\NormalTok{outdt4m}\OperatorTok{$}\NormalTok{data <-}\StringTok{ "Matched with }\CharTok{\textbackslash{}n}\StringTok{Lambda = 200km"}
\NormalTok{outdt5m}\OperatorTok{$}\NormalTok{data <-}\StringTok{ "Matched with }\CharTok{\textbackslash{}n}\StringTok{Lambda = 350km"}

\NormalTok{visdtm <-}\StringTok{ }\KeywordTok{rbind}\NormalTok{(outdt0m,outdt1m,outdt2m,outdt3m,outdt4m,outdt5m)}

\NormalTok{visdtm}\OperatorTok{$}\NormalTok{data <-}\StringTok{ }\KeywordTok{factor}\NormalTok{(visdtm}\OperatorTok{$}\NormalTok{data, }\DataTypeTok{levels =} \KeywordTok{c}\NormalTok{(}\StringTok{"Unmatched"}\NormalTok{,}
                                              \StringTok{"Matched without }\CharTok{\textbackslash{}n}\StringTok{Distance Adj."}\NormalTok{,}
                                              \StringTok{"Matched with }\CharTok{\textbackslash{}n}\StringTok{Lambda = 350km"}\NormalTok{,}
                                              \StringTok{"Matched with }\CharTok{\textbackslash{}n}\StringTok{Lambda = 200km"}\NormalTok{,}
                                              \StringTok{"Matched with }\CharTok{\textbackslash{}n}\StringTok{Lambda = 100km"}\NormalTok{,}
                                              \StringTok{"Matched with }\CharTok{\textbackslash{}n}\StringTok{Lambda = 50km"}\NormalTok{))}
\NormalTok{visdtm}\OperatorTok{$}\NormalTok{pstar <-}\StringTok{ }\KeywordTok{factor}\NormalTok{(}\KeywordTok{ifelse}\NormalTok{(visdtm}\OperatorTok{$}\NormalTok{p}\OperatorTok{>=}\NormalTok{.}\DecValTok{1}\NormalTok{,}\StringTok{"n.s."}\NormalTok{,}\KeywordTok{ifelse}\NormalTok{(visdtm}\OperatorTok{$}\NormalTok{p}\OperatorTok{>=}\NormalTok{.}\DecValTok{05}\NormalTok{,}\StringTok{"p<.1"}\NormalTok{,}\StringTok{"p<.05"}\NormalTok{)),}
                       \DataTypeTok{levels =} \KeywordTok{c}\NormalTok{(}\StringTok{"p<.05"}\NormalTok{,}\StringTok{"p<.1"}\NormalTok{,}\StringTok{"n.s."}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{saveRDS}\NormalTok{(visdtm, }\KeywordTok{paste0}\NormalTok{(projdir, }\StringTok{"/out/visdtm.rds"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{visdt}\OperatorTok{$}\NormalTok{method =}\StringTok{ "OLS"}
\NormalTok{visdtm}\OperatorTok{$}\NormalTok{method =}\StringTok{ "Multinomial Logit}\CharTok{\textbackslash{}n}\StringTok{Agree vs. Disagree"}
\NormalTok{visdtall <-}\StringTok{ }\KeywordTok{rbind}\NormalTok{(visdt,visdtm)}
\NormalTok{visdtall}\OperatorTok{$}\NormalTok{method <-}\StringTok{ }\KeywordTok{factor}\NormalTok{(visdtall}\OperatorTok{$}\NormalTok{method, }\DataTypeTok{levels =} \KeywordTok{unique}\NormalTok{(visdtall}\OperatorTok{$}\NormalTok{method))}
\KeywordTok{colnames}\NormalTok{(visdtall)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{visdt_mail_ols <-}\StringTok{ }\KeywordTok{readRDS}\NormalTok{(}\KeywordTok{paste0}\NormalTok{(projdir, }\StringTok{"/out/visdt_mail_ols.rds"}\NormalTok{))}
\NormalTok{visdt_mail_ols}\OperatorTok{$}\NormalTok{method <-}\StringTok{ "OLS"}
\NormalTok{visdt_mail_multinom <-}\StringTok{ }\KeywordTok{readRDS}\NormalTok{(}\KeywordTok{paste0}\NormalTok{(projdir, }\StringTok{"/out/visdt_mail_multinom.rds"}\NormalTok{))}
\NormalTok{visdt_mail_multinom}\OperatorTok{$}\NormalTok{method <-}\StringTok{ "Multinomial Logit}\CharTok{\textbackslash{}n}\StringTok{Agree vs. Disagree"}
\NormalTok{visdt_mail <-}\StringTok{ }\KeywordTok{rbind}\NormalTok{(visdt_mail_ols,visdt_mail_multinom)}
\NormalTok{visdt_mail}\OperatorTok{$}\NormalTok{lci95 <-}\StringTok{ }\OtherTok{NA}
\NormalTok{visdt_mail}\OperatorTok{$}\NormalTok{uci95 <-}\StringTok{ }\OtherTok{NA}
\NormalTok{visdt_mail}\OperatorTok{$}\NormalTok{lci90 <-}\StringTok{ }\OtherTok{NA}
\NormalTok{visdt_mail}\OperatorTok{$}\NormalTok{uci90 <-}\StringTok{ }\OtherTok{NA}
\KeywordTok{colnames}\NormalTok{(visdt_mail)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{visdtall <-}\StringTok{ }\KeywordTok{rbind}\NormalTok{(visdtall,visdt_mail)}
\NormalTok{visdtall}\OperatorTok{$}\NormalTok{data <-}\StringTok{ }\KeywordTok{factor}\NormalTok{(visdtall}\OperatorTok{$}\NormalTok{data, }\DataTypeTok{levels =} \KeywordTok{unique}\NormalTok{(visdtall}\OperatorTok{$}\NormalTok{data))}
\KeywordTok{table}\NormalTok{(visdtall}\OperatorTok{$}\NormalTok{data)}
\end{Highlighting}
\end{Shaded}
